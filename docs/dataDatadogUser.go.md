...
```go
import "github.com/cdktn-io/cdktn-provider-datadog-go/datadog/v15/datadatadoguser"
...
| <code><a href="#@cdktn/provider-datadog.dataDatadogUser.DataDatadogUserConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.10.0/docs/data-sources/user#id DataDatadogUser#id}. |
