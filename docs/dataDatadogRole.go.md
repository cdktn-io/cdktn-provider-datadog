...
```go
import "github.com/cdktn-io/cdktn-provider-datadog-go/datadog/v13/datadatadogrole"
...
| <code><a href="#@cdktn/provider-datadog.dataDatadogRole.DataDatadogRoleConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.89.0/docs/data-sources/role#id DataDatadogRole#id}. |
