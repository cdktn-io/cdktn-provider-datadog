...
```go
import "github.com/cdktn-io/cdktn-provider-datadog-go/datadog/v13/oncallusernotificationrule"
...
Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/3.90.0/docs/resources/on_call_user_notification_rule#import import section} in the documentation of this resource for the id to use
...
&oncallusernotificationrule.OnCallUserNotificationRuleConfig {
	...
	DelayMinutes: *f64,
	UserId: *string,
	Phone: github.com/cdktn-io/cdktn-provider-datadog-go/datadog/v13.onCallUserNotificationRule.OnCallUserNotificationRulePhone,
}
```
