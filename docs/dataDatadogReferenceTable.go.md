...
```go
import "github.com/cdktn-io/cdktn-provider-datadog-go/datadog/v16/datadatadogreferencetable"
...
&datadatadogreferencetable.DataDatadogReferenceTableConfig {
	...
	Id: *string,
	Schema: github.com/cdktn-io/cdktn-provider-datadog-go/datadog/v16.dataDatadogReferenceTable.DataDatadogReferenceTableSchema,
	TableName: *string,
}
```
