...
```go
import "github.com/cdktn-io/cdktn-provider-datadog-go/datadog/v13/monitorjson"
...
| <code><a href="#@cdktn/provider-datadog.monitorJson.MonitorJsonConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.90.0/docs/resources/monitor_json#id MonitorJson#id}. |
