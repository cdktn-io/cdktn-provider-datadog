...
```go
import "github.com/cdktn-io/cdktn-provider-datadog-go/datadog/v13/apmretentionfilter"
...
&apmretentionfilter.ApmRetentionFilterConfig {
	...
	Name: *string,
	Rate: *string,
	Filter: github.com/cdktn-io/cdktn-provider-datadog-go/datadog/v13.apmRetentionFilter.ApmRetentionFilterFilter,
	TraceRate: *string,
}
```
