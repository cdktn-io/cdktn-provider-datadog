...
```go
import "github.com/cdktn-io/cdktn-provider-datadog-go/datadog/v16/datadatadogtagpipelineruleset"
...
&datadatadogtagpipelineruleset.DataDatadogTagPipelineRulesetRules {
	ReferenceTable: github.com/cdktn-io/cdktn-provider-datadog-go/datadog/v16.dataDatadogTagPipelineRuleset.DataDatadogTagPipelineRulesetRulesReferenceTable,
}
```
