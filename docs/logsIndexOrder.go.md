...
```go
import "github.com/cdktn-io/cdktn-provider-datadog-go/datadog/v13/logsindexorder"
...
| <code><a href="#@cdktn/provider-datadog.logsIndexOrder.LogsIndexOrderConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.90.0/docs/resources/logs_index_order#id LogsIndexOrder#id}. |
