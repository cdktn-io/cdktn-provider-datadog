...
```typescript
public resetCompressionMethod(): void
```
...
```typescript
public resetLookupAttributes(): void
```
...
```typescript
public resetPartitioningAttributes(): void
```
...
```typescript
public readonly compressionMethodInput: string;
```
...
```typescript
public readonly lookupAttributesInput: string[];
```
...
```typescript
public readonly partitioningAttributesInput: string[];
```
...
```typescript
public readonly lookupAttributes: string[];
```
...
```typescript
public readonly partitioningAttributes: string[];
```
