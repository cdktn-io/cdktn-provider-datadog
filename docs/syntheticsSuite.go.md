...
```go
import "github.com/cdktn-io/cdktn-provider-datadog-go/datadog/v16/syntheticssuite"
...
Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/4.19.0/docs/resources/synthetics_suite#import import section} in the documentation of this resource for the id to use
