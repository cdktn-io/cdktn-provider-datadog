...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-datadog.teamNotificationRule.TeamNotificationRuleSlack.property.channel">channel</a></code> | <code>str</code> | Slack channel name for notifications, without a leading '#'. |
