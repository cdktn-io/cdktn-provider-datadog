...
```typescript
import { securityFindingsDueDateRulesOrder } from '@cdktn/provider-datadog'

new securityFindingsDueDateRulesOrder.SecurityFindingsDueDateRulesOrder(scope: Construct, id: string, config: SecurityFindingsDueDateRulesOrderConfig)
```
...
securityFindingsDueDateRulesOrder.SecurityFindingsDueDateRulesOrder.isConstruct(x: any)
```
...
securityFindingsDueDateRulesOrder.SecurityFindingsDueDateRulesOrder.isTerraformElement(x: any)
```
...
securityFindingsDueDateRulesOrder.SecurityFindingsDueDateRulesOrder.isTerraformResource(x: any)
```
...
securityFindingsDueDateRulesOrder.SecurityFindingsDueDateRulesOrder.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktn/provider-datadog.securityFindingsDueDateRulesOrder.SecurityFindingsDueDateRulesOrder.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-datadog.securityFindingsDueDateRulesOrder.SecurityFindingsDueDateRulesOrder.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-datadog.securityFindingsDueDateRulesOrder.SecurityFindingsDueDateRulesOrder.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-datadog.securityFindingsDueDateRulesOrder.SecurityFindingsDueDateRulesOrder.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-datadog.securityFindingsDueDateRulesOrder.SecurityFindingsDueDateRulesOrder.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-datadog.securityFindingsDueDateRulesOrder.SecurityFindingsDueDateRulesOrder.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
...
const securityFindingsDueDateRulesOrderConfig: securityFindingsDueDateRulesOrder.SecurityFindingsDueDateRulesOrderConfig = { ... }
```
...
| <code><a href="#@cdktn/provider-datadog.securityFindingsDueDateRulesOrder.SecurityFindingsDueDateRulesOrderConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-datadog.securityFindingsDueDateRulesOrder.SecurityFindingsDueDateRulesOrderConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-datadog.securityFindingsDueDateRulesOrder.SecurityFindingsDueDateRulesOrderConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-datadog.securityFindingsDueDateRulesOrder.SecurityFindingsDueDateRulesOrderConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
