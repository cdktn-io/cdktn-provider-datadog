...
```go
import "github.com/cdktn-io/cdktn-provider-datadog-go/datadog/v13/slocorrection"
...
| <code><a href="#@cdktn/provider-datadog.sloCorrection.SloCorrectionConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.90.0/docs/resources/slo_correction#id SloCorrection#id}. |
