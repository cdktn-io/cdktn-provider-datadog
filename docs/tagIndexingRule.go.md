...
| <code><a href="#@cdktn/provider-datadog.tagIndexingRule.TagIndexingRuleOptionsData.property.managePreexistingMetrics">ManagePreexistingMetrics</a></code> | <code>interface{}</code> | When true, the rule applies to metrics ingested before the rule was created. |
...
| <code><a href="#@cdktn/provider-datadog.tagIndexingRule.TagIndexingRuleOptionsData.property.overridePreviousRules">OverridePreviousRules</a></code> | <code>interface{}</code> | When true, this rule's tag list overrides tags configured by earlier rules for the same metric. |
