...
| <code><a href="#@cdktn/provider-datadog.logsIndex.LogsIndexConfig.property.disableDailyLimit">DisableDailyLimit</a></code> | <code>bool\|Io.Cdktn.IResolvable</code> | If true, disables the daily limit and sets `daily_limit` to null. |
...
| <code><a href="#@cdktn/provider-datadog.logsIndex.LogsIndexConfig.property.id">Id</a></code> | <code>string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.13.0/docs/resources/logs_index#id LogsIndex#id}. |
...
```csharp
private void ResetSampleAttribute()
```
...
```csharp
public string SampleAttributeInput { get; }
```
