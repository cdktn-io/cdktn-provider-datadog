...
```go
import "github.com/cdktn-io/cdktn-provider-datadog-go/datadog/v14/datadatadogdashboard"
...
| <code><a href="#@cdktn/provider-datadog.dataDatadogDashboard.DataDatadogDashboardConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.91.0/docs/data-sources/dashboard#id DataDatadogDashboard#id}. |
