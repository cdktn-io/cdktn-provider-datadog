...
| <code><a href="#@cdktn/provider-datadog.dataset.DatasetProductFilters.property.product">product</a></code> | <code>java.lang.String</code> | The product type of the dataset. |
