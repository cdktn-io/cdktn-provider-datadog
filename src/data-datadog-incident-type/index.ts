...
// https://registry.terraform.io/providers/datadog/datadog/4.19.0/docs/data-sources/incident_type
...
export class DataDatadogIncidentType extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataDatadogIncidentType that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/4.19.0/docs/data-sources/incident_type#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/datadog/datadog/4.19.0/docs/data-sources/incident_type datadog_incident_type} Data Source
  *
  * @param scope The scope in which to define this construct
