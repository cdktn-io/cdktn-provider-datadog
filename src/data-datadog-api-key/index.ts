...
// https://registry.terraform.io/providers/datadog/datadog/4.17.0/docs/data-sources/api_key
...
export class DataDatadogApiKey extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataDatadogApiKey that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/4.17.0/docs/data-sources/api_key#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/datadog/datadog/4.17.0/docs/data-sources/api_key datadog_api_key} Data Source
  *
  * @param scope The scope in which to define this construct
