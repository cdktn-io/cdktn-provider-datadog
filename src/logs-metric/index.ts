...
// https://registry.terraform.io/providers/datadog/datadog/4.17.0/docs/resources/logs_metric
...
export class LogsMetric extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing LogsMetric that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/4.17.0/docs/resources/logs_metric#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/datadog/datadog/4.17.0/docs/resources/logs_metric datadog_logs_metric} Resource
  *
  * @param scope The scope in which to define this construct
