...
// https://registry.terraform.io/providers/datadog/datadog/4.17.0/docs/resources/team_connection
...
export class TeamConnection extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing TeamConnection that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/4.17.0/docs/resources/team_connection#import import section} in the documentation of this resource for the id to use
