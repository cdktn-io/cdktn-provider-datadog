...
// https://registry.terraform.io/providers/datadog/datadog/4.13.0/docs/resources/team_connection
...
export class TeamConnection extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing TeamConnection that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/4.13.0/docs/resources/team_connection#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/datadog/datadog/4.13.0/docs/resources/team_connection datadog_team_connection} Resource
  *
  * @param scope The scope in which to define this construct
