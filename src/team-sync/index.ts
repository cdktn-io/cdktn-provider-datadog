...
// https://registry.terraform.io/providers/datadog/datadog/4.12.0/docs/resources/team_sync
...
export class TeamSync extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing TeamSync that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/4.12.0/docs/resources/team_sync#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/datadog/datadog/4.12.0/docs/resources/team_sync datadog_team_sync} Resource
  *
  * @param scope The scope in which to define this construct
