...
// https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/team_sync
...
export interface TeamSyncConfig extends cdktn.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/team_sync#frequency TeamSync#frequency}
  */
  readonly frequency?: string;
  /**
  * The external source platform for team synchronization. Valid values are `github`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/team_sync#source TeamSync#source}
  */
  readonly source: string;
  /**
  * Whether to sync members from the external team to the Datadog team. Defaults to `false`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/team_sync#sync_membership TeamSync#sync_membership}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/team_sync#type TeamSync#type}
  */
  readonly type: string;
  /**
  * selection_state block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/team_sync#selection_state TeamSync#selection_state}
  */
...
export interface TeamSyncSelectionStateExternalId {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/team_sync#value TeamSync#value}
  */
...
export interface TeamSyncSelectionState {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/team_sync#operation TeamSync#operation}
  */
  readonly operation?: string;
  /**
  * The scope of the selection. Valid values are `subtree`. Defaults to `"subtree"`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/team_sync#scope TeamSync#scope}
  */
  readonly scope?: string;
  /**
  * external_id block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/team_sync#external_id TeamSync#external_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/team_sync datadog_team_sync}
*/
export class TeamSync extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing TeamSync that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/team_sync#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/team_sync datadog_team_sync} Resource
  *
  * @param scope The scope in which to define this construct
