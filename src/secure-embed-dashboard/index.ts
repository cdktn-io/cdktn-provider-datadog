...
// https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/secure_embed_dashboard
...
export interface SecureEmbedDashboardConfig extends cdktn.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/secure_embed_dashboard#dashboard_id SecureEmbedDashboard#dashboard_id}
  */
  readonly dashboardId: string;
  /**
  * The live span for the global time, e.g. `1h`, `4h`, `1d`, `2d`, `1w`. Defaults to `"1h"`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/secure_embed_dashboard#global_time_live_span SecureEmbedDashboard#global_time_live_span}
  */
  readonly globalTimeLiveSpan?: string;
  /**
  * Whether viewers can change the global time range. Defaults to `true`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/secure_embed_dashboard#global_time_selectable SecureEmbedDashboard#global_time_selectable}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/secure_embed_dashboard#status SecureEmbedDashboard#status}
  */
  readonly status?: string;
  /**
  * Title of the secure embed share.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/secure_embed_dashboard#title SecureEmbedDashboard#title}
  */
  readonly title: string;
  /**
  * Whether to display the dashboard in high density mode. Defaults to `false`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/secure_embed_dashboard#viewing_preferences_high_density SecureEmbedDashboard#viewing_preferences_high_density}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/secure_embed_dashboard#viewing_preferences_theme SecureEmbedDashboard#viewing_preferences_theme}
  */
  readonly viewingPreferencesTheme?: string;
  /**
  * selectable_template_vars block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/secure_embed_dashboard#selectable_template_vars SecureEmbedDashboard#selectable_template_vars}
  */
...
export interface SecureEmbedDashboardSelectableTemplateVars {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/secure_embed_dashboard#default_values SecureEmbedDashboard#default_values}
  */
  readonly defaultValues?: string[];
  /**
  * The name of the template variable.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/secure_embed_dashboard#name SecureEmbedDashboard#name}
  */
  readonly name: string;
  /**
  * The tag prefix for this template variable. Defaults to `""`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/secure_embed_dashboard#prefix SecureEmbedDashboard#prefix}
  */
  readonly prefix?: string;
  /**
  * The type of the template variable. Defaults to `""`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/secure_embed_dashboard#type SecureEmbedDashboard#type}
  */
  readonly type?: string;
  /**
  * The visible tag values for this template variable.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/secure_embed_dashboard#visible_tags SecureEmbedDashboard#visible_tags}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/secure_embed_dashboard datadog_secure_embed_dashboard}
*/
export class SecureEmbedDashboard extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing SecureEmbedDashboard that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/secure_embed_dashboard#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/secure_embed_dashboard datadog_secure_embed_dashboard} Resource
  *
  * @param scope The scope in which to define this construct
