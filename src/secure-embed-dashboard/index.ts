...
// https://registry.terraform.io/providers/datadog/datadog/4.13.0/docs/resources/secure_embed_dashboard
...
export class SecureEmbedDashboard extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing SecureEmbedDashboard that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/4.13.0/docs/resources/secure_embed_dashboard#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/datadog/datadog/4.13.0/docs/resources/secure_embed_dashboard datadog_secure_embed_dashboard} Resource
  *
  * @param scope The scope in which to define this construct
