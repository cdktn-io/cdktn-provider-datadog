...
// https://registry.terraform.io/providers/datadog/datadog/3.90.0/docs/data-sources/workflow_automation
...
export class DataDatadogWorkflowAutomation extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataDatadogWorkflowAutomation that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/3.90.0/docs/data-sources/workflow_automation#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/datadog/datadog/3.90.0/docs/data-sources/workflow_automation datadog_workflow_automation} Data Source
  *
  * @param scope The scope in which to define this construct
