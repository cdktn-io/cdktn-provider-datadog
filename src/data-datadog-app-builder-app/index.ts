...
// https://registry.terraform.io/providers/datadog/datadog/4.8.0/docs/data-sources/app_builder_app
...
export class DataDatadogAppBuilderApp extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataDatadogAppBuilderApp that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/4.8.0/docs/data-sources/app_builder_app#import import section} in the documentation of this resource for the id to use
