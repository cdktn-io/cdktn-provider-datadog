...
// https://registry.terraform.io/providers/datadog/datadog/4.12.0/docs/data-sources/app_builder_app
...
export class DataDatadogAppBuilderApp extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataDatadogAppBuilderApp that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/4.12.0/docs/data-sources/app_builder_app#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/datadog/datadog/4.12.0/docs/data-sources/app_builder_app datadog_app_builder_app} Data Source
  *
  * @param scope The scope in which to define this construct
