...
// https://registry.terraform.io/providers/datadog/datadog/4.9.0/docs/resources/monitor_notification_rule
...
export class MonitorNotificationRule extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing MonitorNotificationRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/4.9.0/docs/resources/monitor_notification_rule#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/datadog/datadog/4.9.0/docs/resources/monitor_notification_rule datadog_monitor_notification_rule} Resource
  *
  * @param scope The scope in which to define this construct
