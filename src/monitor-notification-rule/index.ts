...
// https://registry.terraform.io/providers/datadog/datadog/4.21.0/docs/resources/monitor_notification_rule
...
export interface MonitorNotificationRuleConfig extends cdktn.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.21.0/docs/resources/monitor_notification_rule#name MonitorNotificationRule#name}
  */
  readonly name: string;
  /**
  * List of recipients to notify. Cannot be used with `conditional_recipients`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.21.0/docs/resources/monitor_notification_rule#recipients MonitorNotificationRule#recipients}
  */
  readonly recipients?: string[];
  /**
  * bundle_config block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.21.0/docs/resources/monitor_notification_rule#bundle_config MonitorNotificationRule#bundle_config}
  */
  readonly bundleConfig?: MonitorNotificationRuleBundleConfig;
  /**
  * conditional_recipients block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.21.0/docs/resources/monitor_notification_rule#conditional_recipients MonitorNotificationRule#conditional_recipients}
  */
  readonly conditionalRecipients?: MonitorNotificationRuleConditionalRecipients;
  /**
  * filter block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.21.0/docs/resources/monitor_notification_rule#filter MonitorNotificationRule#filter}
  */
...
export interface MonitorNotificationRuleBundleConfig {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.21.0/docs/resources/monitor_notification_rule#duration MonitorNotificationRule#duration}
  */
...
export interface MonitorNotificationRuleConditionalRecipientsConditions {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.21.0/docs/resources/monitor_notification_rule#scope MonitorNotificationRule#scope}
  */
  readonly scope: string;
}

export function monitorNotificationRuleConditionalRecipientsConditionsToTerraform(struct?: MonitorNotificationRuleConditionalRecipientsConditions | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function monitorNotificationRuleConditionalRecipientsConditionsToHclTerraform(struct?: MonitorNotificationRuleConditionalRecipientsConditions | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class MonitorNotificationRuleConditionalRecipientsConditionsOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  private resolvableValue?: cdktn.IResolvable;
  ...
  */
  ...
  public get internalValue(): MonitorNotificationRuleConditionalRecipientsConditions | cdktn.IResolvable | undefined {
    if (this.resolvableValue) {
      return this.resolvableValue;
    }
    let hasAnyValues = this.isEmptyObject;
  ...
  public set internalValue(value: MonitorNotificationRuleConditionalRecipientsConditions | cdktn.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this.resolvableValue = undefined;
...
export class MonitorNotificationRuleConditionalRecipientsConditionsList extends cdktn.ComplexList {
  public internalValue? : MonitorNotificationRuleConditionalRecipientsConditions[] | cdktn.IResolvable
...
export interface MonitorNotificationRuleConditionalRecipients {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.21.0/docs/resources/monitor_notification_rule#fallback_recipients MonitorNotificationRule#fallback_recipients}
  */
  readonly fallbackRecipients?: string[];
  /**
  * conditions block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.21.0/docs/resources/monitor_notification_rule#conditions MonitorNotificationRule#conditions}
  */
  readonly conditions?: MonitorNotificationRuleConditionalRecipientsConditions[] | cdktn.IResolvable;
}

export function monitorNotificationRuleConditionalRecipientsToTerraform(struct?: MonitorNotificationRuleConditionalRecipients | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
  return {
    fallback_recipients: cdktn.listMapper(cdktn.stringToTerraform, false)(struct!.fallbackRecipients),
    conditions: cdktn.listMapper(monitorNotificationRuleConditionalRecipientsConditionsToTerraform, true)(struct!.conditions),
  }
}


export function monitorNotificationRuleConditionalRecipientsToHclTerraform(struct?: MonitorNotificationRuleConditionalRecipients | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
  const attrs = {
    fallback_recipients: {
      value: cdktn.listMapperHcl(cdktn.stringToHclTerraform, false)(struct!.fallbackRecipients),
      isBlock: false,
      type: "set",
      storageClassType: "stringList",
    },
    conditions: {
      value: cdktn.listMapperHcl(monitorNotificationRuleConditionalRecipientsConditionsToHclTerraform, true)(struct!.conditions),
      isBlock: true,
      type: "list",
...
export class MonitorNotificationRuleConditionalRecipientsOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  private resolvableValue?: cdktn.IResolvable;
  ...
  */
  ...
  public get internalValue(): MonitorNotificationRuleConditionalRecipients | cdktn.IResolvable | undefined {
    if (this.resolvableValue) {
      return this.resolvableValue;
    }
    let hasAnyValues = this.isEmptyObject;
  ...
  public set internalValue(value: MonitorNotificationRuleConditionalRecipients | cdktn.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this.resolvableValue = undefined;
  ...
  public get fallbackRecipients() {
    return cdktn.Fn.tolist(this.getListAttribute('fallback_recipients'));
  }
  ...
  public putConditions(value: MonitorNotificationRuleConditionalRecipientsConditions[] | cdktn.IResolvable) {
...
export interface MonitorNotificationRuleFilter {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.21.0/docs/resources/monitor_notification_rule#tags MonitorNotificationRule#tags}
  */
  readonly tags?: string[];
}

export function monitorNotificationRuleFilterToTerraform(struct?: MonitorNotificationRuleFilter | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function monitorNotificationRuleFilterToHclTerraform(struct?: MonitorNotificationRuleFilter | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class MonitorNotificationRuleFilterOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  private resolvableValue?: cdktn.IResolvable;
  ...
  */
  ...
  public get internalValue(): MonitorNotificationRuleFilter | cdktn.IResolvable | undefined {
    if (this.resolvableValue) {
      return this.resolvableValue;
    }
    let hasAnyValues = this.isEmptyObject;
  ...
  public set internalValue(value: MonitorNotificationRuleFilter | cdktn.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this.resolvableValue = undefined;
      this._scope = undefined;
...
/**
* Represents a {@link https://registry.terraform.io/providers/datadog/datadog/4.21.0/docs/resources/monitor_notification_rule datadog_monitor_notification_rule}
*/
export class MonitorNotificationRule extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing MonitorNotificationRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/4.21.0/docs/resources/monitor_notification_rule#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktn.TerraformProvider) {
        return new cdktn.ImportableResource(scope, importToId, { terraformResourceType: "datadog_monitor_notification_rule", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/datadog/datadog/4.21.0/docs/resources/monitor_notification_rule datadog_monitor_notification_rule} Resource
  *
  * @param scope The scope in which to define this construct
