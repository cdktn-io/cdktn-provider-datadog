...
// https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/org_group_membership
...
export interface OrgGroupMembershipConfig extends cdktn.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/org_group_membership#org_group_id OrgGroupMembership#org_group_id}
  */
  readonly orgGroupId: string;
  /**
  * The UUID of the organization. Must be a valid UUID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/org_group_membership#org_uuid OrgGroupMembership#org_uuid}
  */
  readonly orgUuid: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/org_group_membership datadog_org_group_membership}
*/
export class OrgGroupMembership extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing OrgGroupMembership that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/org_group_membership#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/org_group_membership datadog_org_group_membership} Resource
  *
  * @param scope The scope in which to define this construct
