...
// https://registry.terraform.io/providers/datadog/datadog/4.15.0/docs/resources/org_group_membership
...
export class OrgGroupMembership extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing OrgGroupMembership that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/4.15.0/docs/resources/org_group_membership#import import section} in the documentation of this resource for the id to use
