...
// https://registry.terraform.io/providers/datadog/datadog/3.90.0/docs/data-sources/role_users
...
export class DataDatadogRoleUsers extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataDatadogRoleUsers that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/3.90.0/docs/data-sources/role_users#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/datadog/datadog/3.90.0/docs/data-sources/role_users datadog_role_users} Data Source
  *
  * @param scope The scope in which to define this construct
