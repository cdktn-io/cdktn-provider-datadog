...
// https://registry.terraform.io/providers/datadog/datadog/4.8.0/docs/resources/csm_threats_agent_rule
...
export class CsmThreatsAgentRule extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing CsmThreatsAgentRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/4.8.0/docs/resources/csm_threats_agent_rule#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/datadog/datadog/4.8.0/docs/resources/csm_threats_agent_rule datadog_csm_threats_agent_rule} Resource
  *
  * @param scope The scope in which to define this construct
