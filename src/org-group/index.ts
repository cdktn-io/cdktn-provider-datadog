...
// https://registry.terraform.io/providers/datadog/datadog/4.19.0/docs/resources/org_group
...
export class OrgGroup extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing OrgGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/4.19.0/docs/resources/org_group#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/datadog/datadog/4.19.0/docs/resources/org_group datadog_org_group} Resource
  *
  * @param scope The scope in which to define this construct
