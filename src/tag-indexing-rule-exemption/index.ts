...
// https://registry.terraform.io/providers/datadog/datadog/4.21.0/docs/resources/tag_indexing_rule_exemption
...
export interface TagIndexingRuleExemptionConfig extends cdktn.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.21.0/docs/resources/tag_indexing_rule_exemption#metric_name TagIndexingRuleExemption#metric_name}
  */
  readonly metricName: string;
  /**
  * The reason the metric is exempt from tag indexing rules. Changing this value forces a new resource to be created.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.21.0/docs/resources/tag_indexing_rule_exemption#reason TagIndexingRuleExemption#reason}
  */
  readonly reason: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/datadog/datadog/4.21.0/docs/resources/tag_indexing_rule_exemption datadog_tag_indexing_rule_exemption}
*/
export class TagIndexingRuleExemption extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing TagIndexingRuleExemption that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/4.21.0/docs/resources/tag_indexing_rule_exemption#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/datadog/datadog/4.21.0/docs/resources/tag_indexing_rule_exemption datadog_tag_indexing_rule_exemption} Resource
  *
  * @param scope The scope in which to define this construct
