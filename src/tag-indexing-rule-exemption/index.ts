...
// https://registry.terraform.io/providers/datadog/datadog/4.20.0/docs/resources/tag_indexing_rule_exemption
...
export class TagIndexingRuleExemption extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing TagIndexingRuleExemption that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/4.20.0/docs/resources/tag_indexing_rule_exemption#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/datadog/datadog/4.20.0/docs/resources/tag_indexing_rule_exemption datadog_tag_indexing_rule_exemption} Resource
  *
  * @param scope The scope in which to define this construct
