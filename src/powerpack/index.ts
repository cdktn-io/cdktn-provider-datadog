...
export interface PowerpackConfig extends cdktn.TerraformMetaArguments {
  ...
  */
  ...
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.12.0/docs/resources/powerpack#id Powerpack#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.12.0/docs/resources/powerpack#show_title Powerpack#show_title}
  */
  ...
  * layout block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.12.0/docs/resources/powerpack#layout Powerpack#layout}
  */
  readonly layout?: PowerpackLayout;
  /**
  * template_variables block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.12.0/docs/resources/powerpack#template_variables Powerpack#template_variables}
  */
  readonly templateVariables?: PowerpackTemplateVariables[] | cdktn.IResolvable;
  /**
  * widget block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.12.0/docs/resources/powerpack#widget Powerpack#widget}
  */
  readonly widget?: PowerpackWidget[] | cdktn.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/datadog/datadog/4.12.0/docs/resources/powerpack datadog_powerpack}
*/
export class Powerpack extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing Powerpack that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/4.12.0/docs/resources/powerpack#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/datadog/datadog/4.12.0/docs/resources/powerpack datadog_powerpack} Resource
  *
  * @param scope The scope in which to define this construct
