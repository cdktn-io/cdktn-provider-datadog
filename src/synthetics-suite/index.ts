...
// https://registry.terraform.io/providers/datadog/datadog/4.20.0/docs/resources/synthetics_suite
...
export interface SyntheticsSuiteConfig extends cdktn.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.20.0/docs/resources/synthetics_suite#message SyntheticsSuite#message}
  */
  readonly message?: string;
  /**
  * Name of the Synthetics suite.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.20.0/docs/resources/synthetics_suite#name SyntheticsSuite#name}
  */
  readonly name: string;
  /**
  * A set of tags to associate with your synthetics suite.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.20.0/docs/resources/synthetics_suite#tags SyntheticsSuite#tags}
  */
  readonly tags?: string[];
  /**
  * options block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.20.0/docs/resources/synthetics_suite#options SyntheticsSuite#options}
  */
  readonly options?: SyntheticsSuiteOptions[] | cdktn.IResolvable;
  /**
  * tests block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.20.0/docs/resources/synthetics_suite#tests SyntheticsSuite#tests}
  */
...
export interface SyntheticsSuiteOptions {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.20.0/docs/resources/synthetics_suite#alerting_threshold SyntheticsSuite#alerting_threshold}
  */
...
export interface SyntheticsSuiteTests {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.20.0/docs/resources/synthetics_suite#alerting_criticality SyntheticsSuite#alerting_criticality}
  */
  readonly alertingCriticality?: string;
  /**
  * Public ID of the test.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.20.0/docs/resources/synthetics_suite#public_id SyntheticsSuite#public_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/datadog/datadog/4.20.0/docs/resources/synthetics_suite datadog_synthetics_suite}
*/
export class SyntheticsSuite extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing SyntheticsSuite that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/4.20.0/docs/resources/synthetics_suite#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/datadog/datadog/4.20.0/docs/resources/synthetics_suite datadog_synthetics_suite} Resource
  *
  * @param scope The scope in which to define this construct
