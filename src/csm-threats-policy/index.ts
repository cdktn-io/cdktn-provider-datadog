...
// https://registry.terraform.io/providers/datadog/datadog/4.12.0/docs/resources/csm_threats_policy
...
export class CsmThreatsPolicy extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing CsmThreatsPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/4.12.0/docs/resources/csm_threats_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/datadog/datadog/4.12.0/docs/resources/csm_threats_policy datadog_csm_threats_policy} Resource
  *
  * @param scope The scope in which to define this construct
