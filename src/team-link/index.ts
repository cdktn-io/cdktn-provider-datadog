...
// https://registry.terraform.io/providers/datadog/datadog/4.8.0/docs/resources/team_link
...
export class TeamLink extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing TeamLink that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/4.8.0/docs/resources/team_link#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/datadog/datadog/4.8.0/docs/resources/team_link datadog_team_link} Resource
  *
  * @param scope The scope in which to define this construct
