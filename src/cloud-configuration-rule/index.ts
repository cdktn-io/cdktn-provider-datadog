...
// https://registry.terraform.io/providers/datadog/datadog/4.20.0/docs/resources/cloud_configuration_rule
...
export interface CloudConfigurationRuleConfig extends cdktn.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.20.0/docs/resources/cloud_configuration_rule#group_by CloudConfigurationRule#group_by}
  */
  ...
  */
  readonly id?: string;
  /**
  * The message associated to the rule that will be shown in findings and signals. For cloud configuration rules, the message is rendered in the finding side panel. When the message is written as Markdown, you can use top-level section headers to control where each part appears in the finding: `Description` appears under **What Happened**, and `Remediation` appears in its own **Remediation** section. You can also include a `Rationale` section, which is shown within **What Happened** after the description. All sections are optional and can appear in any order; a typical message uses only `Description` and `Remediation`. Use level-2 (`##`) headers for each section. If none of these headers are present, the entire message is shown as the description.
  *
...
export class CloudConfigurationRule extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing CloudConfigurationRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/4.20.0/docs/resources/cloud_configuration_rule#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/datadog/datadog/4.20.0/docs/resources/cloud_configuration_rule datadog_cloud_configuration_rule} Resource
  *
  * @param scope The scope in which to define this construct
