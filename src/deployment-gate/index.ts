...
// https://registry.terraform.io/providers/datadog/datadog/4.8.0/docs/resources/deployment_gate
...
export class DeploymentGate extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing DeploymentGate that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/4.8.0/docs/resources/deployment_gate#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/datadog/datadog/4.8.0/docs/resources/deployment_gate datadog_deployment_gate} Resource
  *
  * @param scope The scope in which to define this construct
