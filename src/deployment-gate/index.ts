...
// https://registry.terraform.io/providers/datadog/datadog/4.21.0/docs/resources/deployment_gate
...
export interface DeploymentGateConfig extends cdktn.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.21.0/docs/resources/deployment_gate#dry_run DeploymentGate#dry_run}
  */
  readonly dryRun?: boolean | cdktn.IResolvable;
  /**
  * The target environment (example: dev).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.21.0/docs/resources/deployment_gate#env DeploymentGate#env}
  */
  readonly env: string;
  /**
  * Unique name for multiple gates on the same service/environment.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.21.0/docs/resources/deployment_gate#identifier DeploymentGate#identifier}
  */
  readonly identifier?: string;
  /**
  * The service name (example: transaction-backend).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.21.0/docs/resources/deployment_gate#service DeploymentGate#service}
  */
  readonly service: string;
  /**
  * rule block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.21.0/docs/resources/deployment_gate#rule DeploymentGate#rule}
  */
...
export interface DeploymentGateRuleOptions {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.21.0/docs/resources/deployment_gate#duration DeploymentGate#duration}
  */
  readonly duration?: number;
  /**
  * Resources to exclude from faulty deployment detection.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.21.0/docs/resources/deployment_gate#excluded_resources DeploymentGate#excluded_resources}
  */
  readonly excludedResources?: string[];
  /**
  * The query for monitor rules.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.21.0/docs/resources/deployment_gate#query DeploymentGate#query}
  */
...
export interface DeploymentGateRule {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.21.0/docs/resources/deployment_gate#name DeploymentGate#name}
  */
  readonly name: string;
  /**
  * The rule type (e.g., 'faulty_deployment_detection', 'monitor').
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.21.0/docs/resources/deployment_gate#type DeploymentGate#type}
  */
  readonly type: string;
  /**
  * options block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.21.0/docs/resources/deployment_gate#options DeploymentGate#options}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/datadog/datadog/4.21.0/docs/resources/deployment_gate datadog_deployment_gate}
*/
export class DeploymentGate extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing DeploymentGate that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/4.21.0/docs/resources/deployment_gate#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/datadog/datadog/4.21.0/docs/resources/deployment_gate datadog_deployment_gate} Resource
  *
  * @param scope The scope in which to define this construct
