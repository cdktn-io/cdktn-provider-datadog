...
// https://registry.terraform.io/providers/datadog/datadog/4.8.0/docs/resources/cost_budget
...
export class CostBudget extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing CostBudget that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/4.8.0/docs/resources/cost_budget#import import section} in the documentation of this resource for the id to use
