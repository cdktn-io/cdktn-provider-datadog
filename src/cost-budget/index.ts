...
// https://registry.terraform.io/providers/datadog/datadog/4.20.0/docs/resources/cost_budget
...
export class CostBudget extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing CostBudget that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/4.20.0/docs/resources/cost_budget#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/datadog/datadog/4.20.0/docs/resources/cost_budget datadog_cost_budget} Resource
  *
  * @param scope The scope in which to define this construct
