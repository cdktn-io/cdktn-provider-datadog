...
// https://registry.terraform.io/providers/datadog/datadog/4.19.0/docs/data-sources/software_catalog
...
export interface DataDatadogSoftwareCatalogConfig extends cdktn.TerraformMetaArguments {
  ...
  */
  readonly includeDiscovered?: boolean | cdktn.IResolvable;
}
...
export class DataDatadogSoftwareCatalog extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataDatadogSoftwareCatalog that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/4.19.0/docs/data-sources/software_catalog#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/datadog/datadog/4.19.0/docs/data-sources/software_catalog datadog_software_catalog} Data Source
  *
  * @param scope The scope in which to define this construct
  ...
  */
  public constructor(scope: Construct, id: string, config: DataDatadogSoftwareCatalogConfig = {}) {
    ...
    this._includeDiscovered = config.includeDiscovered;
  }
  ...
  // include_discovered - computed: false, optional: true, required: false
  private _includeDiscovered?: boolean | cdktn.IResolvable; 
  public get includeDiscovered() {
    return this.getBooleanAttribute('include_discovered');
  }
  public set includeDiscovered(value: boolean | cdktn.IResolvable) {
    this._includeDiscovered = value;
  }
  public resetIncludeDiscovered() {
    this._includeDiscovered = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get includeDiscoveredInput() {
    return this._includeDiscovered;
  }
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      include_discovered: cdktn.booleanToTerraform(this._includeDiscovered),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      include_discovered: {
        value: cdktn.booleanToHclTerraform(this._includeDiscovered),
        isBlock: false,
        type: "simple",
