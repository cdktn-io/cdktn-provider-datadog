...
// https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/service_access_token
...
export interface ServiceAccessTokenConfig extends cdktn.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/service_access_token#expires_at ServiceAccessToken#expires_at}
  */
  readonly expiresAt?: string;
  /**
  * Name of the service access token. Must be non-empty. String length must be at least 1.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/service_access_token#name ServiceAccessToken#name}
  */
  readonly name: string;
  /**
  * Authorization scopes granted to the service access token. At least one scope is required.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/service_access_token#scopes ServiceAccessToken#scopes}
  */
  readonly scopes: string[];
  /**
  * ID of the service account that owns this access token.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/service_access_token#service_account_id ServiceAccessToken#service_account_id}
  */
  readonly serviceAccountId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/service_access_token datadog_service_access_token}
*/
export class ServiceAccessToken extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ServiceAccessToken that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/service_access_token#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/service_access_token datadog_service_access_token} Resource
  *
  * @param scope The scope in which to define this construct
