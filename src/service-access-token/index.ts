...
// https://registry.terraform.io/providers/datadog/datadog/4.13.0/docs/resources/service_access_token
...
export class ServiceAccessToken extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ServiceAccessToken that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/4.13.0/docs/resources/service_access_token#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/datadog/datadog/4.13.0/docs/resources/service_access_token datadog_service_access_token} Resource
  *
  * @param scope The scope in which to define this construct
