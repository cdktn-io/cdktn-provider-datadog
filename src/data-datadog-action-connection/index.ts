...
// https://registry.terraform.io/providers/datadog/datadog/4.21.0/docs/data-sources/action_connection
...
export interface DataDatadogActionConnectionConfig extends cdktn.TerraformMetaArguments {
  ...
  * ID for Connection.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.21.0/docs/data-sources/action_connection#id DataDatadogActionConnection#id}
  *
  ...
  * http block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.21.0/docs/data-sources/action_connection#http DataDatadogActionConnection#http}
  */
...
export interface DataDatadogActionConnectionHttpTokenAuth {
  ...
  * header block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.21.0/docs/data-sources/action_connection#header DataDatadogActionConnection#header}
  */
  readonly header?: DataDatadogActionConnectionHttpTokenAuthHeader[] | cdktn.IResolvable;
  /**
  * token block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.21.0/docs/data-sources/action_connection#token DataDatadogActionConnection#token}
  */
  readonly token?: DataDatadogActionConnectionHttpTokenAuthToken[] | cdktn.IResolvable;
  /**
  * url_parameter block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.21.0/docs/data-sources/action_connection#url_parameter DataDatadogActionConnection#url_parameter}
  */
...
export interface DataDatadogActionConnectionHttp {
  ...
  * token_auth block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.21.0/docs/data-sources/action_connection#token_auth DataDatadogActionConnection#token_auth}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/datadog/datadog/4.21.0/docs/data-sources/action_connection datadog_action_connection}
*/
export class DataDatadogActionConnection extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataDatadogActionConnection that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/4.21.0/docs/data-sources/action_connection#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/datadog/datadog/4.21.0/docs/data-sources/action_connection datadog_action_connection} Data Source
  *
  * @param scope The scope in which to define this construct
