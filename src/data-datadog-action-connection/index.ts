...
// https://registry.terraform.io/providers/datadog/datadog/3.90.0/docs/data-sources/action_connection
...
export class DataDatadogActionConnection extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataDatadogActionConnection that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/3.90.0/docs/data-sources/action_connection#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/datadog/datadog/3.90.0/docs/data-sources/action_connection datadog_action_connection} Data Source
  *
  * @param scope The scope in which to define this construct
