...
// https://registry.terraform.io/providers/datadog/datadog/3.90.0/docs/data-sources/powerpack
...
export class DataDatadogPowerpack extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataDatadogPowerpack that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/3.90.0/docs/data-sources/powerpack#import import section} in the documentation of this resource for the id to use
