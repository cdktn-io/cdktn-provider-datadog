...
// https://registry.terraform.io/providers/datadog/datadog/4.17.0/docs/resources/cost_custom_forecast
...
export class CostCustomForecast extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing CostCustomForecast that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/4.17.0/docs/resources/cost_custom_forecast#import import section} in the documentation of this resource for the id to use
