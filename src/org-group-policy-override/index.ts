...
// https://registry.terraform.io/providers/datadog/datadog/4.17.0/docs/resources/org_group_policy_override
...
export class OrgGroupPolicyOverride extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing OrgGroupPolicyOverride that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/4.17.0/docs/resources/org_group_policy_override#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/datadog/datadog/4.17.0/docs/resources/org_group_policy_override datadog_org_group_policy_override} Resource
  *
  * @param scope The scope in which to define this construct
