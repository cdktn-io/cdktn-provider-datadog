...
// https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/org_group_policy_override
...
export interface OrgGroupPolicyOverrideConfig extends cdktn.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/org_group_policy_override#org_group_id OrgGroupPolicyOverride#org_group_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/org_group_policy_override#org_site OrgGroupPolicyOverride#org_site}
  */
  readonly orgSite: string;
  /**
  * The UUID of the organization being exempted from the policy. Must be a valid UUID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/org_group_policy_override#org_uuid OrgGroupPolicyOverride#org_uuid}
  */
  readonly orgUuid: string;
  /**
  * The UUID of the org group policy the override applies to. Must be a valid UUID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/org_group_policy_override#policy_id OrgGroupPolicyOverride#policy_id}
  */
  readonly policyId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/org_group_policy_override datadog_org_group_policy_override}
*/
export class OrgGroupPolicyOverride extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing OrgGroupPolicyOverride that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/org_group_policy_override#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/org_group_policy_override datadog_org_group_policy_override} Resource
  *
  * @param scope The scope in which to define this construct
