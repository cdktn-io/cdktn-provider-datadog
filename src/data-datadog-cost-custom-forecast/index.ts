...
// https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/data-sources/cost_custom_forecast
...
export interface DataDatadogCostCustomForecastConfig extends cdktn.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/data-sources/cost_custom_forecast#budget_uid DataDatadogCostCustomForecast#budget_uid}
  */
  readonly budgetUid: string;
  /**
  * entries block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/data-sources/cost_custom_forecast#entries DataDatadogCostCustomForecast#entries}
  */
...
export interface DataDatadogCostCustomForecastEntries {
  ...
  * tag_filters block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/data-sources/cost_custom_forecast#tag_filters DataDatadogCostCustomForecast#tag_filters}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/data-sources/cost_custom_forecast datadog_cost_custom_forecast}
*/
export class DataDatadogCostCustomForecast extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataDatadogCostCustomForecast that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/data-sources/cost_custom_forecast#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/data-sources/cost_custom_forecast datadog_cost_custom_forecast} Data Source
  *
  * @param scope The scope in which to define this construct
