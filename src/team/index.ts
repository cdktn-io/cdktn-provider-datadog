...
// https://registry.terraform.io/providers/datadog/datadog/4.9.0/docs/resources/team
...
export class Team extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing Team that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/4.9.0/docs/resources/team#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/datadog/datadog/4.9.0/docs/resources/team datadog_team} Resource
  *
  * @param scope The scope in which to define this construct
