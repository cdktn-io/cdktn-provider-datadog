...
// https://registry.terraform.io/providers/datadog/datadog/4.8.0/docs/resources/team_permission_setting
...
export class TeamPermissionSetting extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing TeamPermissionSetting that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/4.8.0/docs/resources/team_permission_setting#import import section} in the documentation of this resource for the id to use
