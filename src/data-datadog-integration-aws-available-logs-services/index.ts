...
// https://registry.terraform.io/providers/datadog/datadog/4.12.1/docs/data-sources/integration_aws_available_logs_services
...
export class DataDatadogIntegrationAwsAvailableLogsServices extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataDatadogIntegrationAwsAvailableLogsServices that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/4.12.1/docs/data-sources/integration_aws_available_logs_services#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/datadog/datadog/4.12.1/docs/data-sources/integration_aws_available_logs_services datadog_integration_aws_available_logs_services} Data Source
  *
  * @param scope The scope in which to define this construct
