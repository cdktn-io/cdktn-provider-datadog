...
// https://registry.terraform.io/providers/datadog/datadog/4.11.0/docs/data-sources/datastore
...
export class DataDatadogDatastore extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataDatadogDatastore that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/4.11.0/docs/data-sources/datastore#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/datadog/datadog/4.11.0/docs/data-sources/datastore datadog_datastore} Data Source
  *
  * @param scope The scope in which to define this construct
