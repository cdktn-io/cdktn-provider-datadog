...
// https://registry.terraform.io/providers/datadog/datadog/4.17.0/docs/resources/sensitive_data_scanner_group
...
export class SensitiveDataScannerGroup extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing SensitiveDataScannerGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/4.17.0/docs/resources/sensitive_data_scanner_group#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/datadog/datadog/4.17.0/docs/resources/sensitive_data_scanner_group datadog_sensitive_data_scanner_group} Resource
  *
  * @param scope The scope in which to define this construct
