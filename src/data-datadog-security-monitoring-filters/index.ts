...
// https://registry.terraform.io/providers/datadog/datadog/4.10.0/docs/data-sources/security_monitoring_filters
...
export class DataDatadogSecurityMonitoringFiltersFiltersExclusionFilterOutputReference extends cdktn.ComplexObject {
...
export class DataDatadogSecurityMonitoringFiltersFiltersExclusionFilterList extends cdktn.ComplexList {
...
export class DataDatadogSecurityMonitoringFiltersFiltersOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataDatadogSecurityMonitoringFiltersFiltersList extends cdktn.ComplexList {
...
*/
export class DataDatadogSecurityMonitoringFilters extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataDatadogSecurityMonitoringFilters that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/4.10.0/docs/data-sources/security_monitoring_filters#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktn.TerraformProvider) {
        return new cdktn.ImportableResource(scope, importToId, { terraformResourceType: "datadog_security_monitoring_filters", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/datadog/datadog/4.10.0/docs/data-sources/security_monitoring_filters datadog_security_monitoring_filters} Data Source
  *
  * @param scope The scope in which to define this construct
