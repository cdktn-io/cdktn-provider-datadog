...
export interface DashboardV2Config extends cdktn.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/dashboard_v2#dashboard_lists DashboardV2#dashboard_lists}
  */
  readonly dashboardLists?: number[];
  /**
  * A list of dashboard lists this dashboard should be removed from. Internal only.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/dashboard_v2#dashboard_lists_removed DashboardV2#dashboard_lists_removed}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/dashboard_v2#is_read_only DashboardV2#is_read_only}
  */
  readonly isReadOnly?: boolean | cdktn.IResolvable;
  /**
  * The layout type of the dashboard. Valid values are `ordered`, `free`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/dashboard_v2#layout_type DashboardV2#layout_type}
  */
  readonly layoutType: string;
  /**
  * The list of handles for the users to notify when changes are made to this dashboard.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/dashboard_v2#notify_list DashboardV2#notify_list}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/dashboard_v2#reflow_type DashboardV2#reflow_type}
  */
  readonly reflowType?: string;
  /**
  * A list of role identifiers. Only the author and users associated with at least one of these roles can edit this dashboard.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/dashboard_v2#restricted_roles DashboardV2#restricted_roles}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/dashboard_v2#validate DashboardV2#validate}
  */
  readonly validate?: boolean | cdktn.IResolvable;
  /**
  * tab block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/dashboard_v2#tab DashboardV2#tab}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/dashboard_v2#template_variable_preset DashboardV2#template_variable_preset}
  */
  readonly templateVariablePreset?: DashboardV2TemplateVariablePreset[] | cdktn.IResolvable;
  /**
  * widget block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/dashboard_v2#widget DashboardV2#widget}
  */
  readonly widget?: DashboardV2Widget[] | cdktn.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/dashboard_v2 datadog_dashboard_v2}
*/
export class DashboardV2 extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing DashboardV2 that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/dashboard_v2#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/dashboard_v2 datadog_dashboard_v2} Resource
  *
  * @param scope The scope in which to define this construct
