...
// https://registry.terraform.io/providers/datadog/datadog/4.13.0/docs/resources/tag_pipeline_rulesets
...
export interface TagPipelineRulesetsConfig extends cdktn.TerraformMetaArguments {
  /**
...
*/
export class TagPipelineRulesets extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing TagPipelineRulesets that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/4.13.0/docs/resources/tag_pipeline_rulesets#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktn.TerraformProvider) {
        return new cdktn.ImportableResource(scope, importToId, { terraformResourceType: "datadog_tag_pipeline_rulesets", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/datadog/datadog/4.13.0/docs/resources/tag_pipeline_rulesets datadog_tag_pipeline_rulesets} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      ruleset_ids: cdktn.listMapper(cdktn.stringToTerraform, false)(this._rulesetIds),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      ruleset_ids: {
        value: cdktn.listMapperHcl(cdktn.stringToHclTerraform, false)(this._rulesetIds),
        isBlock: false,
        type: "list",
