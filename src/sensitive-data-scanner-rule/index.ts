...
// https://registry.terraform.io/providers/datadog/datadog/4.12.0/docs/resources/sensitive_data_scanner_rule
...
export class SensitiveDataScannerRule extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing SensitiveDataScannerRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/4.12.0/docs/resources/sensitive_data_scanner_rule#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/datadog/datadog/4.12.0/docs/resources/sensitive_data_scanner_rule datadog_sensitive_data_scanner_rule} Resource
  *
  * @param scope The scope in which to define this construct
