...
// https://registry.terraform.io/providers/datadog/datadog/4.20.0/docs/resources/organization_settings
...
export class OrganizationSettingsSettingsOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  // saml_autocreate_access_role - computed: true, optional: true, required: false
...
export class OrganizationSettings extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing OrganizationSettings that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/4.20.0/docs/resources/organization_settings#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/datadog/datadog/4.20.0/docs/resources/organization_settings datadog_organization_settings} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  public constructor(scope: Construct, id: string, config: OrganizationSettingsConfig = {}) {
    ...
    this._securityContacts = config.securityContacts;
  ...
  // security_contacts - computed: true, optional: true, required: false
  private _securityContacts?: string[]; 
  public get securityContacts() {
    return this.getListAttribute('security_contacts');
  }
  public set securityContacts(value: string[]) {
    this._securityContacts = value;
  }
  public resetSecurityContacts() {
    this._securityContacts = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get securityContactsInput() {
    return this._securityContacts;
  }
