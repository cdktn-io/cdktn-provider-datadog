...
// https://registry.terraform.io/providers/datadog/datadog/4.20.0/docs/data-sources/logs_pipelines
...
export class DataDatadogLogsPipelinesLogsPipelinesFilterOutputReference extends cdktn.ComplexObject {
...
export class DataDatadogLogsPipelinesLogsPipelinesFilterList extends cdktn.ComplexList {
...
export class DataDatadogLogsPipelinesLogsPipelinesOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataDatadogLogsPipelinesLogsPipelinesList extends cdktn.ComplexList {
...
*/
export class DataDatadogLogsPipelines extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataDatadogLogsPipelines that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/4.20.0/docs/data-sources/logs_pipelines#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktn.TerraformProvider) {
        return new cdktn.ImportableResource(scope, importToId, { terraformResourceType: "datadog_logs_pipelines", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/datadog/datadog/4.20.0/docs/data-sources/logs_pipelines datadog_logs_pipelines} Data Source
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      is_read_only: cdktn.stringToTerraform(this._isReadOnly),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      is_read_only: {
        value: cdktn.stringToHclTerraform(this._isReadOnly),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
