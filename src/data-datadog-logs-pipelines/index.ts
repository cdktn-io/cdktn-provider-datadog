...
// https://registry.terraform.io/providers/datadog/datadog/4.12.1/docs/data-sources/logs_pipelines
...
export class DataDatadogLogsPipelines extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataDatadogLogsPipelines that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/4.12.1/docs/data-sources/logs_pipelines#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/datadog/datadog/4.12.1/docs/data-sources/logs_pipelines datadog_logs_pipelines} Data Source
  *
  * @param scope The scope in which to define this construct
