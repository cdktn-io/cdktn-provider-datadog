...
// https://registry.terraform.io/providers/datadog/datadog/4.17.0/docs/resources/rum_retention_filters_order
...
export class RumRetentionFiltersOrder extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing RumRetentionFiltersOrder that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/4.17.0/docs/resources/rum_retention_filters_order#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/datadog/datadog/4.17.0/docs/resources/rum_retention_filters_order datadog_rum_retention_filters_order} Resource
  *
  * @param scope The scope in which to define this construct
