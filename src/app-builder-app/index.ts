...
// https://registry.terraform.io/providers/datadog/datadog/4.16.0/docs/resources/app_builder_app
...
export class AppBuilderApp extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing AppBuilderApp that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/4.16.0/docs/resources/app_builder_app#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/datadog/datadog/4.16.0/docs/resources/app_builder_app datadog_app_builder_app} Resource
  *
  * @param scope The scope in which to define this construct
