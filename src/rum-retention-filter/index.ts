...
// https://registry.terraform.io/providers/datadog/datadog/4.12.1/docs/resources/rum_retention_filter
...
export class RumRetentionFilter extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing RumRetentionFilter that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/4.12.1/docs/resources/rum_retention_filter#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/datadog/datadog/4.12.1/docs/resources/rum_retention_filter datadog_rum_retention_filter} Resource
  *
  * @param scope The scope in which to define this construct
