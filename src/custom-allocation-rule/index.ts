...
// https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/custom_allocation_rule
...
export interface CustomAllocationRuleConfig extends cdktn.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/custom_allocation_rule#enabled CustomAllocationRule#enabled}
  */
  readonly enabled: boolean | cdktn.IResolvable;
  /**
  * List of cloud providers the rule applies to. Valid values include `aws`, `azure`, and `gcp`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/custom_allocation_rule#providernames CustomAllocationRule#providernames}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/custom_allocation_rule#rule_name CustomAllocationRule#rule_name}
  */
  readonly ruleName: string;
  /**
  * costs_to_allocate block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/custom_allocation_rule#costs_to_allocate CustomAllocationRule#costs_to_allocate}
  */
  readonly costsToAllocate?: CustomAllocationRuleCostsToAllocate[] | cdktn.IResolvable;
  /**
  * strategy block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/custom_allocation_rule#strategy CustomAllocationRule#strategy}
  */
...
export interface CustomAllocationRuleCostsToAllocate {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/custom_allocation_rule#condition CustomAllocationRule#condition}
  */
  readonly condition?: string;
  /**
  * The tag key to filter on (e.g., `aws_product`, `team`, `environment`).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/custom_allocation_rule#tag CustomAllocationRule#tag}
  */
  readonly tag?: string;
  /**
  * The single tag value to match. Use this field for conditions like `=`, `!=`, `is`, `is not`, `like`. Do not use with `in` or `not in` conditions.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/custom_allocation_rule#value CustomAllocationRule#value}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/custom_allocation_rule#values CustomAllocationRule#values}
  */
...
export interface CustomAllocationRuleStrategyAllocatedByAllocatedTags {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/custom_allocation_rule#key CustomAllocationRule#key}
  */
  readonly key?: string;
  /**
...
export interface CustomAllocationRuleStrategyAllocatedBy {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/custom_allocation_rule#percentage CustomAllocationRule#percentage}
  */
  readonly percentage?: number;
  /**
  * allocated_tags block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/custom_allocation_rule#allocated_tags CustomAllocationRule#allocated_tags}
  */
...
export interface CustomAllocationRuleStrategyBasedOnTimeseries {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/custom_allocation_rule#json CustomAllocationRule#json}
  */
...
export interface CustomAllocationRuleStrategy {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/custom_allocation_rule#allocated_by_tag_keys CustomAllocationRule#allocated_by_tag_keys}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/custom_allocation_rule#evaluate_grouped_by_tag_keys CustomAllocationRule#evaluate_grouped_by_tag_keys}
  */
  readonly evaluateGroupedByTagKeys?: string[];
  /**
  * The granularity level for cost allocation. Valid values are `daily` or `monthly`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/custom_allocation_rule#granularity CustomAllocationRule#granularity}
  */
  readonly granularity?: string;
  /**
  * The allocation method. Valid values are `even`, `percent`, `proportional`, `proportional_timeseries`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/custom_allocation_rule#method CustomAllocationRule#method}
  */
  readonly method?: string;
  /**
  * allocated_by block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/custom_allocation_rule#allocated_by CustomAllocationRule#allocated_by}
  */
  readonly allocatedBy?: CustomAllocationRuleStrategyAllocatedBy[] | cdktn.IResolvable;
  /**
  * allocated_by_filters block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/custom_allocation_rule#allocated_by_filters CustomAllocationRule#allocated_by_filters}
  */
  readonly allocatedByFilters?: CustomAllocationRuleStrategyAllocatedByFilters[] | cdktn.IResolvable;
  /**
  * based_on_costs block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/custom_allocation_rule#based_on_costs CustomAllocationRule#based_on_costs}
  */
  readonly basedOnCosts?: CustomAllocationRuleStrategyBasedOnCosts[] | cdktn.IResolvable;
  /**
  * based_on_timeseries block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/custom_allocation_rule#based_on_timeseries CustomAllocationRule#based_on_timeseries}
  */
  readonly basedOnTimeseries?: CustomAllocationRuleStrategyBasedOnTimeseries;
  /**
  * evaluate_grouped_by_filters block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/custom_allocation_rule#evaluate_grouped_by_filters CustomAllocationRule#evaluate_grouped_by_filters}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/custom_allocation_rule datadog_custom_allocation_rule}
*/
export class CustomAllocationRule extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing CustomAllocationRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/custom_allocation_rule#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/custom_allocation_rule datadog_custom_allocation_rule} Resource
  *
  * @param scope The scope in which to define this construct
