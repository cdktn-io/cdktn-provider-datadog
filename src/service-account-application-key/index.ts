...
// https://registry.terraform.io/providers/datadog/datadog/3.89.0/docs/resources/service_account_application_key
...
export class ServiceAccountApplicationKey extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ServiceAccountApplicationKey that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/3.89.0/docs/resources/service_account_application_key#import import section} in the documentation of this resource for the id to use
