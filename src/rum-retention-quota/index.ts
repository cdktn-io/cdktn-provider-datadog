...
// https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/rum_retention_quota
...
export interface RumRetentionQuotaConfig extends cdktn.TerraformMetaArguments {
  ...
  * RUM application ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/rum_retention_quota#application_id RumRetentionQuota#application_id}
  */
  readonly applicationId: string;
  /**
  * The retention quota mode. Valid values are `custom`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/rum_retention_quota#mode RumRetentionQuota#mode}
  */
  readonly mode: string;
  /**
  * custom block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/rum_retention_quota#custom RumRetentionQuota#custom}
  */
...
export interface RumRetentionQuotaCustom {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/rum_retention_quota#daily_reset_time RumRetentionQuota#daily_reset_time}
  */
  readonly dailyResetTime: string;
  /**
  * The UTC offset for `daily_reset_time`, in `±HH:MM` format.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/rum_retention_quota#daily_reset_timezone RumRetentionQuota#daily_reset_timezone}
  */
  readonly dailyResetTimezone: string;
  /**
  * The action taken after the quota is reached. Valid values are `stop`, `slowdown`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/rum_retention_quota#quota_reached_action RumRetentionQuota#quota_reached_action}
  */
  readonly quotaReachedAction: string;
  /**
  * The maximum number of sessions to retain within the window.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/rum_retention_quota#session_limit RumRetentionQuota#session_limit}
  */
  readonly sessionLimit: number;
  /**
  * The window over which the quota resets. Valid values are `daily`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/rum_retention_quota#window_type RumRetentionQuota#window_type}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/rum_retention_quota datadog_rum_retention_quota}
*/
export class RumRetentionQuota extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing RumRetentionQuota that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/rum_retention_quota#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/rum_retention_quota datadog_rum_retention_quota} Resource
  *
  * @param scope The scope in which to define this construct
