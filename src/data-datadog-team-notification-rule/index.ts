...
// https://registry.terraform.io/providers/datadog/datadog/4.11.0/docs/data-sources/team_notification_rule
...
export interface DataDatadogTeamNotificationRuleConfig extends cdktn.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.11.0/docs/data-sources/team_notification_rule#rule_id DataDatadogTeamNotificationRule#rule_id}
  */
  readonly ruleId: string;
  /**
  * The team ID to fetch the notification rule for.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.11.0/docs/data-sources/team_notification_rule#team_id DataDatadogTeamNotificationRule#team_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/datadog/datadog/4.11.0/docs/data-sources/team_notification_rule datadog_team_notification_rule}
*/
export class DataDatadogTeamNotificationRule extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataDatadogTeamNotificationRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/4.11.0/docs/data-sources/team_notification_rule#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/datadog/datadog/4.11.0/docs/data-sources/team_notification_rule datadog_team_notification_rule} Data Source
  *
  * @param scope The scope in which to define this construct
