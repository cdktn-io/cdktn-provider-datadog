...
// https://registry.terraform.io/providers/datadog/datadog/4.20.0/docs/resources/ip_allowlist
...
export class IpAllowlist extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing IpAllowlist that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/4.20.0/docs/resources/ip_allowlist#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/datadog/datadog/4.20.0/docs/resources/ip_allowlist datadog_ip_allowlist} Resource
  *
  * @param scope The scope in which to define this construct
