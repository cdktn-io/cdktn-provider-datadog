...
// https://registry.terraform.io/providers/datadog/datadog/4.13.0/docs/data-sources/monitor_config_policies
...
export class DataDatadogMonitorConfigPoliciesMonitorConfigPoliciesTagPolicyOutputReference extends cdktn.ComplexObject {
...
export class DataDatadogMonitorConfigPoliciesMonitorConfigPoliciesTagPolicyList extends cdktn.ComplexList {
...
export class DataDatadogMonitorConfigPoliciesMonitorConfigPoliciesOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataDatadogMonitorConfigPoliciesMonitorConfigPoliciesList extends cdktn.ComplexList {
...
export class DataDatadogMonitorConfigPolicies extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataDatadogMonitorConfigPolicies that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/4.13.0/docs/data-sources/monitor_config_policies#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktn.TerraformProvider) {
        return new cdktn.ImportableResource(scope, importToId, { terraformResourceType: "datadog_monitor_config_policies", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/datadog/datadog/4.13.0/docs/data-sources/monitor_config_policies datadog_monitor_config_policies} Data Source
  *
  * @param scope The scope in which to define this construct
