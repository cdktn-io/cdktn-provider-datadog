...
// https://registry.terraform.io/providers/datadog/datadog/4.21.0/docs/resources/integration_fastly_account
...
export interface IntegrationFastlyAccountConfig extends cdktn.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.21.0/docs/resources/integration_fastly_account#api_key IntegrationFastlyAccount#api_key}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.21.0/docs/resources/integration_fastly_account#api_key_wo IntegrationFastlyAccount#api_key_wo}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.21.0/docs/resources/integration_fastly_account#api_key_wo_version IntegrationFastlyAccount#api_key_wo_version}
  */
  readonly apiKeyWoVersion?: string;
  /**
  * The name of the Fastly account.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.21.0/docs/resources/integration_fastly_account#name IntegrationFastlyAccount#name}
  */
  readonly name: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/datadog/datadog/4.21.0/docs/resources/integration_fastly_account datadog_integration_fastly_account}
*/
export class IntegrationFastlyAccount extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing IntegrationFastlyAccount that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/4.21.0/docs/resources/integration_fastly_account#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/datadog/datadog/4.21.0/docs/resources/integration_fastly_account datadog_integration_fastly_account} Resource
  *
  * @param scope The scope in which to define this construct
