...
// https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/incident_user_defined_field
...
export interface IncidentUserDefinedFieldConfig extends cdktn.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/incident_user_defined_field#category IncidentUserDefinedField#category}
  */
  readonly category?: string;
  /**
  * The default value for the field. Must be one of the valid values when `valid_values` is set.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/incident_user_defined_field#default_value IncidentUserDefinedField#default_value}
  */
  readonly defaultValue?: string;
  /**
  * The human-readable name shown in the UI. Defaults to a formatted version of the name if not provided.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/incident_user_defined_field#display_name IncidentUserDefinedField#display_name}
  */
  readonly displayName?: string;
  /**
  * The ID of the incident type this field is associated with. Changing the incident type forces a new resource.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/incident_user_defined_field#incident_type IncidentUserDefinedField#incident_type}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/incident_user_defined_field#name IncidentUserDefinedField#name}
  */
  readonly name: string;
  /**
  * A decimal string representing the field's display order in the UI. Assigned by the server when not provided.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/incident_user_defined_field#ordinal IncidentUserDefinedField#ordinal}
  */
  readonly ordinal?: string;
  /**
  * When true, users must fill out this field on incidents. Defaults to `false`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/incident_user_defined_field#required IncidentUserDefinedField#required}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/incident_user_defined_field#tag_key IncidentUserDefinedField#tag_key}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/incident_user_defined_field#type IncidentUserDefinedField#type}
  */
  readonly type: string;
  /**
  * valid_value block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/incident_user_defined_field#valid_value IncidentUserDefinedField#valid_value}
  */
...
export interface IncidentUserDefinedFieldValidValue {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/incident_user_defined_field#description IncidentUserDefinedField#description}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/incident_user_defined_field#short_description IncidentUserDefinedField#short_description}
  */
  readonly shortDescription?: string;
  /**
  * The identifier that is stored when this option is selected.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/incident_user_defined_field#value IncidentUserDefinedField#value}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/incident_user_defined_field datadog_incident_user_defined_field}
*/
export class IncidentUserDefinedField extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing IncidentUserDefinedField that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/incident_user_defined_field#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/incident_user_defined_field datadog_incident_user_defined_field} Resource
  *
  * @param scope The scope in which to define this construct
