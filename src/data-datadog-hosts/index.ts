...
// https://registry.terraform.io/providers/datadog/datadog/4.8.0/docs/data-sources/hosts
...
export class DataDatadogHosts extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataDatadogHosts that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/4.8.0/docs/data-sources/hosts#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/datadog/datadog/4.8.0/docs/data-sources/hosts datadog_hosts} Data Source
  *
  * @param scope The scope in which to define this construct
