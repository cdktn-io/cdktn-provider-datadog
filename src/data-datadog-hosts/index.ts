...
// https://registry.terraform.io/providers/datadog/datadog/3.91.0/docs/data-sources/hosts
...
export interface DataDatadogHostsConfig extends cdktn.TerraformMetaArguments {
  /**
...
export class DataDatadogHostsHostListMetaOutputReference extends cdktn.ComplexObject {
...
export class DataDatadogHostsHostListMetricsOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataDatadogHostsHostListStructOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  private _tagsBySource = new cdktn.StringListMap(this, "tags_by_source");
...
export class DataDatadogHostsHostListStructList extends cdktn.ComplexList {
...
export class DataDatadogHosts extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataDatadogHosts that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/3.91.0/docs/data-sources/hosts#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the DataDatadogHosts to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktn.TerraformProvider) {
        return new cdktn.ImportableResource(scope, importToId, { terraformResourceType: "datadog_hosts", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/datadog/datadog/3.91.0/docs/data-sources/hosts datadog_hosts} Data Source
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  private _includeMutedHostsData?: boolean | cdktn.IResolvable; 
  public get includeMutedHostsData() {
    return this.getBooleanAttribute('include_muted_hosts_data');
  }
  public set includeMutedHostsData(value: boolean | cdktn.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      from: cdktn.numberToTerraform(this._from),
      include_muted_hosts_data: cdktn.booleanToTerraform(this._includeMutedHostsData),
      sort_dir: cdktn.stringToTerraform(this._sortDir),
      sort_field: cdktn.stringToTerraform(this._sortField),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      from: {
        value: cdktn.numberToHclTerraform(this._from),
        isBlock: false,
        type: "simple",
        storageClassType: "number",
      },
      include_muted_hosts_data: {
        value: cdktn.booleanToHclTerraform(this._includeMutedHostsData),
        isBlock: false,
        type: "simple",
        storageClassType: "boolean",
      },
      sort_dir: {
        value: cdktn.stringToHclTerraform(this._sortDir),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
      sort_field: {
        value: cdktn.stringToHclTerraform(this._sortField),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
