...
// https://registry.terraform.io/providers/datadog/datadog/3.90.0/docs/resources/datastore_item
...
/**
* Represents a {@link https://registry.terraform.io/providers/datadog/datadog/3.90.0/docs/resources/datastore_item datadog_datastore_item}
*/
export class DatastoreItem extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing DatastoreItem that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/3.90.0/docs/resources/datastore_item#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/datadog/datadog/3.90.0/docs/resources/datastore_item datadog_datastore_item} Resource
  *
  * @param scope The scope in which to define this construct
