...
// https://registry.terraform.io/providers/datadog/datadog/4.15.0/docs/resources/azure_uc_config
...
export class AzureUcConfig extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing AzureUcConfig that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/4.15.0/docs/resources/azure_uc_config#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/datadog/datadog/4.15.0/docs/resources/azure_uc_config datadog_azure_uc_config} Resource
  *
  * @param scope The scope in which to define this construct
