...
// https://registry.terraform.io/providers/datadog/datadog/4.21.0/docs/data-sources/integration_aws_account
...
export interface DataDatadogIntegrationAwsAccountConfig extends cdktn.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.21.0/docs/data-sources/integration_aws_account#aws_account_id DataDatadogIntegrationAwsAccount#aws_account_id}
  */
  readonly awsAccountId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/datadog/datadog/4.21.0/docs/data-sources/integration_aws_account datadog_integration_aws_account}
*/
export class DataDatadogIntegrationAwsAccount extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataDatadogIntegrationAwsAccount that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/4.21.0/docs/data-sources/integration_aws_account#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/datadog/datadog/4.21.0/docs/data-sources/integration_aws_account datadog_integration_aws_account} Data Source
  *
  * @param scope The scope in which to define this construct
