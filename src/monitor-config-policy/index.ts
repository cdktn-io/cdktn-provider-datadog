...
// https://registry.terraform.io/providers/datadog/datadog/4.20.0/docs/resources/monitor_config_policy
...
export class MonitorConfigPolicy extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing MonitorConfigPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/4.20.0/docs/resources/monitor_config_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/datadog/datadog/4.20.0/docs/resources/monitor_config_policy datadog_monitor_config_policy} Resource
  *
  * @param scope The scope in which to define this construct
