...
// https://registry.terraform.io/providers/datadog/datadog/3.90.0/docs/resources/app_key_registration
...
export class AppKeyRegistration extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing AppKeyRegistration that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/3.90.0/docs/resources/app_key_registration#import import section} in the documentation of this resource for the id to use
