...
// https://registry.terraform.io/providers/datadog/datadog/4.21.0/docs/data-sources/role_permissions
...
export interface DataDatadogRolePermissionsConfig extends cdktn.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.21.0/docs/data-sources/role_permissions#role_id DataDatadogRolePermissions#role_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/datadog/datadog/4.21.0/docs/data-sources/role_permissions datadog_role_permissions}
*/
export class DataDatadogRolePermissions extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataDatadogRolePermissions that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/4.21.0/docs/data-sources/role_permissions#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/datadog/datadog/4.21.0/docs/data-sources/role_permissions datadog_role_permissions} Data Source
  *
  * @param scope The scope in which to define this construct
