...
// https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/tag_rule
...
export interface TagRuleConfig extends cdktn.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/tag_rule#enabled TagRule#enabled}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/tag_rule#force_blocking_on_create TagRule#force_blocking_on_create}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/tag_rule#hard_delete TagRule#hard_delete}
  */
  readonly hardDelete?: boolean | cdktn.IResolvable;
  /**
  * Human-readable name for the tag rule.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/tag_rule#name TagRule#name}
  */
  readonly name: string;
  /**
  * When `true`, the rule matches tag values that do NOT match any of the supplied patterns. Defaults to `false`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/tag_rule#negated TagRule#negated}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/tag_rule#required TagRule#required}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/tag_rule#rule_type TagRule#rule_type}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/tag_rule#scope TagRule#scope}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/tag_rule#source TagRule#source}
  */
  readonly source: string;
  /**
  * The tag key that the rule governs (for example, `service`).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/tag_rule#tag_key TagRule#tag_key}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/tag_rule#tag_value_patterns TagRule#tag_value_patterns}
  */
  readonly tagValuePatterns: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/tag_rule datadog_tag_rule}
*/
export class TagRule extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing TagRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/tag_rule#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/tag_rule datadog_tag_rule} Resource
  *
  * @param scope The scope in which to define this construct
