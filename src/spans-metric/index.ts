...
// https://registry.terraform.io/providers/datadog/datadog/4.10.0/docs/resources/spans_metric
...
export class SpansMetric extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing SpansMetric that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/4.10.0/docs/resources/spans_metric#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/datadog/datadog/4.10.0/docs/resources/spans_metric datadog_spans_metric} Resource
  *
  * @param scope The scope in which to define this construct
