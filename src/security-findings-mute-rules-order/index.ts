...
// https://registry.terraform.io/providers/datadog/datadog/4.21.0/docs/resources/security_findings_mute_rules_order
...
export interface SecurityFindingsMuteRulesOrderConfig extends cdktn.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.21.0/docs/resources/security_findings_mute_rules_order#name SecurityFindingsMuteRulesOrder#name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.21.0/docs/resources/security_findings_mute_rules_order#rule_ids SecurityFindingsMuteRulesOrder#rule_ids}
  */
  readonly ruleIds: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/datadog/datadog/4.21.0/docs/resources/security_findings_mute_rules_order datadog_security_findings_mute_rules_order}
*/
export class SecurityFindingsMuteRulesOrder extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing SecurityFindingsMuteRulesOrder that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/4.21.0/docs/resources/security_findings_mute_rules_order#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/datadog/datadog/4.21.0/docs/resources/security_findings_mute_rules_order datadog_security_findings_mute_rules_order} Resource
  *
  * @param scope The scope in which to define this construct
