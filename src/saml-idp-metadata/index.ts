...
// https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/saml_idp_metadata
...
export interface SamlIdpMetadataConfig extends cdktn.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/saml_idp_metadata#idp_metadata SamlIdpMetadata#idp_metadata}
  */
  readonly idpMetadata: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/saml_idp_metadata datadog_saml_idp_metadata}
*/
export class SamlIdpMetadata extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing SamlIdpMetadata that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/saml_idp_metadata#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/saml_idp_metadata datadog_saml_idp_metadata} Resource
  *
  * @param scope The scope in which to define this construct
