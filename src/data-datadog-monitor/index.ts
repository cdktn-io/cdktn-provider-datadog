...
// https://registry.terraform.io/providers/datadog/datadog/4.10.0/docs/data-sources/monitor
...
export class DataDatadogMonitor extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataDatadogMonitor that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/4.10.0/docs/data-sources/monitor#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/datadog/datadog/4.10.0/docs/data-sources/monitor datadog_monitor} Data Source
  *
  * @param scope The scope in which to define this construct
