...
// https://registry.terraform.io/providers/datadog/datadog/4.16.0/docs/data-sources/integration_aws_iam_permissions_resource_collection
...
export class DataDatadogIntegrationAwsIamPermissionsResourceCollection extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataDatadogIntegrationAwsIamPermissionsResourceCollection that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/4.16.0/docs/data-sources/integration_aws_iam_permissions_resource_collection#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/datadog/datadog/4.16.0/docs/data-sources/integration_aws_iam_permissions_resource_collection datadog_integration_aws_iam_permissions_resource_collection} Data Source
  *
  * @param scope The scope in which to define this construct
