...
// https://registry.terraform.io/providers/datadog/datadog/4.10.0/docs/resources/action_connection
...
export class ActionConnection extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ActionConnection that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/4.10.0/docs/resources/action_connection#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/datadog/datadog/4.10.0/docs/resources/action_connection datadog_action_connection} Resource
  *
  * @param scope The scope in which to define this construct
