...
// https://registry.terraform.io/providers/datadog/datadog/4.21.0/docs
...
export interface DatadogProviderConfig {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.21.0/docs#api_key DatadogProvider#api_key}
  */
  readonly apiKey?: string;
  /**
  * The API URL. This can also be set via the DD_HOST environment variable, and defaults to `https://api.datadoghq.com`. Note that this URL must not end with the `/api/` path. For example, `https://api.datadoghq.com/` is a correct value, while `https://api.datadoghq.com/api/` is not. And if you're working with "EU" version of Datadog, use `https://api.datadoghq.eu/`. Other Datadog region examples: `https://api.us5.datadoghq.com/`, `https://api.us3.datadoghq.com/` and `https://api.ddog-gov.com/`. See https://docs.datadoghq.com/getting_started/site/ for all available regions.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.21.0/docs#api_url DatadogProvider#api_url}
  */
  readonly apiUrl?: string;
  /**
  * (Required unless validate is false) Datadog APP key. This can also be set via the DD_APP_KEY environment variable.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.21.0/docs#app_key DatadogProvider#app_key}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.21.0/docs#aws_access_key_id DatadogProvider#aws_access_key_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.21.0/docs#aws_secret_access_key DatadogProvider#aws_secret_access_key}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.21.0/docs#aws_session_token DatadogProvider#aws_session_token}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.21.0/docs#bearer_token DatadogProvider#bearer_token}
  */
  readonly bearerToken?: string;
  /**
  * The cloud provider region specifier; used for cloud-provider-based authentication. For example, `us-east-1` for AWS.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.21.0/docs#cloud_provider_region DatadogProvider#cloud_provider_region}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.21.0/docs#cloud_provider_type DatadogProvider#cloud_provider_type}
  */
  readonly cloudProviderType?: string;
  /**
  * The HTTP request retry back off base. Defaults to 2.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.21.0/docs#http_client_retry_backoff_base DatadogProvider#http_client_retry_backoff_base}
  */
  readonly httpClientRetryBackoffBase?: number;
  /**
  * The HTTP request retry back off multiplier. Defaults to 2.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.21.0/docs#http_client_retry_backoff_multiplier DatadogProvider#http_client_retry_backoff_multiplier}
  */
  readonly httpClientRetryBackoffMultiplier?: number;
  /**
  * Enables request retries on HTTP status codes 429 and 5xx. Valid values are [`true`, `false`]. Defaults to `true`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.21.0/docs#http_client_retry_enabled DatadogProvider#http_client_retry_enabled}
  */
  readonly httpClientRetryEnabled?: string;
  /**
  * The maximum random delay added to each HTTP request retry. Defaults to 0 seconds.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.21.0/docs#http_client_retry_jitter DatadogProvider#http_client_retry_jitter}
  */
  readonly httpClientRetryJitter?: number;
  /**
  * The HTTP request maximum retry number. Defaults to 3.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.21.0/docs#http_client_retry_max_retries DatadogProvider#http_client_retry_max_retries}
  */
  readonly httpClientRetryMaxRetries?: number;
  /**
  * The HTTP request retry timeout period. Defaults to 60 seconds.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.21.0/docs#http_client_retry_timeout DatadogProvider#http_client_retry_timeout}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.21.0/docs#ignore_tag_keys DatadogProvider#ignore_tag_keys}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.21.0/docs#org_uuid DatadogProvider#org_uuid}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.21.0/docs#validate DatadogProvider#validate}
  */
  readonly validate?: string;
  /**
  * Alias name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.21.0/docs#alias DatadogProvider#alias}
  */
  readonly alias?: string;
  /**
  * default_tags block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.21.0/docs#default_tags DatadogProvider#default_tags}
  */
...
export interface DatadogProviderDefaultTags {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.21.0/docs#tags DatadogProvider#tags}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/datadog/datadog/4.21.0/docs datadog}
*/
export class DatadogProvider extends cdktn.TerraformProvider {
  ...
  * @param importFromId The id of the existing DatadogProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/4.21.0/docs#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the DatadogProvider to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktn.TerraformProvider) {
        return new cdktn.ImportableResource(scope, importToId, { terraformResourceType: "datadog", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/datadog/datadog/4.21.0/docs datadog} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  public constructor(scope: Construct, id: string, config: DatadogProviderConfig = {}) {
    ...
    this._httpClientRetryJitter = config.httpClientRetryJitter;
  ...
  // http_client_retry_jitter - computed: false, optional: true, required: false
  private _httpClientRetryJitter?: number; 
  public get httpClientRetryJitter() {
    return this._httpClientRetryJitter;
  }
  public set httpClientRetryJitter(value: number | undefined) {
    this._httpClientRetryJitter = value;
  }
  public resetHttpClientRetryJitter() {
    this._httpClientRetryJitter = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get httpClientRetryJitterInput() {
    return this._httpClientRetryJitter;
  }
  ...
  public set ignoreTagKeys(value: string[] | undefined) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      app_key: cdktn.stringToTerraform(this._appKey),
      ...
      bearer_token: cdktn.stringToTerraform(this._bearerToken),
      cloud_provider_region: cdktn.stringToTerraform(this._cloudProviderRegion),
      cloud_provider_type: cdktn.stringToTerraform(this._cloudProviderType),
      http_client_retry_backoff_base: cdktn.numberToTerraform(this._httpClientRetryBackoffBase),
      http_client_retry_backoff_multiplier: cdktn.numberToTerraform(this._httpClientRetryBackoffMultiplier),
      http_client_retry_enabled: cdktn.stringToTerraform(this._httpClientRetryEnabled),
      http_client_retry_jitter: cdktn.numberToTerraform(this._httpClientRetryJitter),
      http_client_retry_max_retries: cdktn.numberToTerraform(this._httpClientRetryMaxRetries),
      http_client_retry_timeout: cdktn.numberToTerraform(this._httpClientRetryTimeout),
      ...
      validate: cdktn.stringToTerraform(this._validate),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      app_key: {
        value: cdktn.stringToHclTerraform(this._appKey),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
      ...
      bearer_token: {
        value: cdktn.stringToHclTerraform(this._bearerToken),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
      cloud_provider_region: {
        value: cdktn.stringToHclTerraform(this._cloudProviderRegion),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
      cloud_provider_type: {
        value: cdktn.stringToHclTerraform(this._cloudProviderType),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
      http_client_retry_backoff_base: {
        value: cdktn.numberToHclTerraform(this._httpClientRetryBackoffBase),
        isBlock: false,
        type: "simple",
        storageClassType: "number",
      },
      http_client_retry_backoff_multiplier: {
        value: cdktn.numberToHclTerraform(this._httpClientRetryBackoffMultiplier),
        isBlock: false,
        type: "simple",
        storageClassType: "number",
      },
      http_client_retry_enabled: {
        value: cdktn.stringToHclTerraform(this._httpClientRetryEnabled),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
      http_client_retry_jitter: {
        value: cdktn.numberToHclTerraform(this._httpClientRetryJitter),
        isBlock: false,
        type: "simple",
        storageClassType: "number",
      },
      http_client_retry_max_retries: {
        value: cdktn.numberToHclTerraform(this._httpClientRetryMaxRetries),
        isBlock: false,
        type: "simple",
        storageClassType: "number",
      },
      http_client_retry_timeout: {
        value: cdktn.numberToHclTerraform(this._httpClientRetryTimeout),
        isBlock: false,
        type: "simple",
        storageClassType: "number",
      },
      ...
      validate: {
        value: cdktn.stringToHclTerraform(this._validate),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
