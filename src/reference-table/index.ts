...
// https://registry.terraform.io/providers/datadog/datadog/4.15.0/docs/resources/reference_table
...
export class ReferenceTable extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ReferenceTable that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/4.15.0/docs/resources/reference_table#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/datadog/datadog/4.15.0/docs/resources/reference_table datadog_reference_table} Resource
  *
  * @param scope The scope in which to define this construct
