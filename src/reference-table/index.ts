...
// https://registry.terraform.io/providers/datadog/datadog/4.8.0/docs/resources/reference_table
...
export class ReferenceTable extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ReferenceTable that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/4.8.0/docs/resources/reference_table#import import section} in the documentation of this resource for the id to use
