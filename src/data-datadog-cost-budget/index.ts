...
// https://registry.terraform.io/providers/datadog/datadog/4.17.0/docs/data-sources/cost_budget
...
export class DataDatadogCostBudget extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataDatadogCostBudget that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/4.17.0/docs/data-sources/cost_budget#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/datadog/datadog/4.17.0/docs/data-sources/cost_budget datadog_cost_budget} Data Source
  *
  * @param scope The scope in which to define this construct
