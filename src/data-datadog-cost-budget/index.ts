...
// https://registry.terraform.io/providers/datadog/datadog/3.90.0/docs/data-sources/cost_budget
...
export interface DataDatadogCostBudgetConfig extends cdktn.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.90.0/docs/data-sources/cost_budget#id DataDatadogCostBudget#id}
  *
  ...
  * budget_line block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.90.0/docs/data-sources/cost_budget#budget_line DataDatadogCostBudget#budget_line}
  */
  readonly budgetLine?: DataDatadogCostBudgetBudgetLine[] | cdktn.IResolvable;
  /**
  * entries block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.90.0/docs/data-sources/cost_budget#entries DataDatadogCostBudget#entries}
  */
...
export class DataDatadogCostBudget extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataDatadogCostBudget that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/3.90.0/docs/data-sources/cost_budget#import import section} in the documentation of this resource for the id to use
