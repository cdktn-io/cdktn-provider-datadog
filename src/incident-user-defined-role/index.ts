...
// https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/incident_user_defined_role
...
export interface IncidentUserDefinedRoleConfig extends cdktn.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/incident_user_defined_role#description IncidentUserDefinedRole#description}
  */
  readonly description?: string;
  /**
  * The ID of the incident type this user-defined role is associated with.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/incident_user_defined_role#incident_type IncidentUserDefinedRole#incident_type}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/incident_user_defined_role#name IncidentUserDefinedRole#name}
  */
  readonly name: string;
  /**
  * Policy configuration for the user-defined role. Defaults to a multi-assignee policy when omitted.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/incident_user_defined_role#policy IncidentUserDefinedRole#policy}
  */
...
export interface IncidentUserDefinedRolePolicy {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/incident_user_defined_role#is_single IncidentUserDefinedRole#is_single}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/incident_user_defined_role datadog_incident_user_defined_role}
*/
export class IncidentUserDefinedRole extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing IncidentUserDefinedRole that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/incident_user_defined_role#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/incident_user_defined_role datadog_incident_user_defined_role} Resource
  *
  * @param scope The scope in which to define this construct
