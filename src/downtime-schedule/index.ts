...
// https://registry.terraform.io/providers/datadog/datadog/4.20.0/docs/resources/downtime_schedule
...
export class DowntimeSchedule extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing DowntimeSchedule that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/4.20.0/docs/resources/downtime_schedule#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/datadog/datadog/4.20.0/docs/resources/downtime_schedule datadog_downtime_schedule} Resource
  *
  * @param scope The scope in which to define this construct
