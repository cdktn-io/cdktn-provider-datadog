...
// https://registry.terraform.io/providers/datadog/datadog/4.21.0/docs/resources/service_account
...
export interface ServiceAccountConfig extends cdktn.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.21.0/docs/resources/service_account#disabled ServiceAccount#disabled}
  */
  readonly disabled?: boolean | cdktn.IResolvable;
  /**
  * Email of the associated user.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.21.0/docs/resources/service_account#email ServiceAccount#email}
  */
  readonly email: string;
  /**
  * Name for the service account.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.21.0/docs/resources/service_account#name ServiceAccount#name}
  */
  readonly name?: string;
  /**
  * A list of role IDs to assign to the service account.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.21.0/docs/resources/service_account#roles ServiceAccount#roles}
  */
  readonly roles?: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/datadog/datadog/4.21.0/docs/resources/service_account datadog_service_account}
*/
export class ServiceAccount extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ServiceAccount that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/4.21.0/docs/resources/service_account#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/datadog/datadog/4.21.0/docs/resources/service_account datadog_service_account} Resource
  *
  * @param scope The scope in which to define this construct
