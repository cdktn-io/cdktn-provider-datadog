...
// https://registry.terraform.io/providers/datadog/datadog/4.12.0/docs/resources/security_notification_rule
...
export interface SecurityNotificationRuleConfig extends cdktn.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.12.0/docs/resources/security_notification_rule#targets SecurityNotificationRule#targets}
  */
...
export class SecurityNotificationRule extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing SecurityNotificationRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/4.12.0/docs/resources/security_notification_rule#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/datadog/datadog/4.12.0/docs/resources/security_notification_rule datadog_security_notification_rule} Resource
  *
  * @param scope The scope in which to define this construct
