...
// https://registry.terraform.io/providers/datadog/datadog/4.12.0/docs/data-sources/team_notification_rules
...
export interface DataDatadogTeamNotificationRulesConfig extends cdktn.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.12.0/docs/data-sources/team_notification_rules#team_id DataDatadogTeamNotificationRules#team_id}
  */
  readonly teamId: string;
  /**
  * notification_rules block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.12.0/docs/data-sources/team_notification_rules#notification_rules DataDatadogTeamNotificationRules#notification_rules}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/datadog/datadog/4.12.0/docs/data-sources/team_notification_rules datadog_team_notification_rules}
*/
export class DataDatadogTeamNotificationRules extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataDatadogTeamNotificationRules that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/4.12.0/docs/data-sources/team_notification_rules#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/datadog/datadog/4.12.0/docs/data-sources/team_notification_rules datadog_team_notification_rules} Data Source
  *
  * @param scope The scope in which to define this construct
