...
// https://registry.terraform.io/providers/datadog/datadog/4.10.0/docs/resources/service_level_objective
...
export class ServiceLevelObjective extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ServiceLevelObjective that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/4.10.0/docs/resources/service_level_objective#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/datadog/datadog/4.10.0/docs/resources/service_level_objective datadog_service_level_objective} Resource
  *
  * @param scope The scope in which to define this construct
