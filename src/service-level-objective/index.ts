...
// https://registry.terraform.io/providers/datadog/datadog/4.20.0/docs/resources/service_level_objective
...
export function serviceLevelObjectiveSliSpecificationCountToHclTerraform(struct?: ServiceLevelObjectiveSliSpecificationCountOutputReference | ServiceLevelObjectiveSliSpecificationCount): any {
  ...
  const attrs = {
    bad_events_formula: {
      value: cdktn.stringToHclTerraform(struct!.badEventsFormula),
      isBlock: false,
      type: "simple",
      storageClassType: "string",
    },
...
export class ServiceLevelObjectiveSliSpecificationCountOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): ServiceLevelObjectiveSliSpecificationCount | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    if (this._badEventsFormula !== undefined) {
      hasAnyValues = true;
      internalValueResult.badEventsFormula = this._badEventsFormula;
    }
  ...
  public set internalValue(value: ServiceLevelObjectiveSliSpecificationCount | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this._badEventsFormula = undefined;
      ...
      this.isEmptyObject = Object.keys(value).length === 0;
      this._badEventsFormula = value.badEventsFormula;
  ...
  // bad_events_formula - computed: false, optional: true, required: false
  private _badEventsFormula?: string; 
  public get badEventsFormula() {
    return this.getStringAttribute('bad_events_formula');
  }
  public set badEventsFormula(value: string) {
    this._badEventsFormula = value;
  }
  public resetBadEventsFormula() {
    this._badEventsFormula = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get badEventsFormulaInput() {
    return this._badEventsFormula;
  }
  ...
  // total_events_formula - computed: false, optional: true, required: false
  ...
  public resetTotalEventsFormula() {
    this._totalEventsFormula = undefined;
  }
  // Temporarily expose input value. Use with caution.
...
export class ServiceLevelObjective extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ServiceLevelObjective that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/4.20.0/docs/resources/service_level_objective#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/datadog/datadog/4.20.0/docs/resources/service_level_objective datadog_service_level_objective} Resource
  *
  * @param scope The scope in which to define this construct
