...
// https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/data-sources/datastore_item
...
export interface DataDatadogDatastoreItemConfig extends cdktn.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/data-sources/datastore_item#datastore_id DataDatadogDatastoreItem#datastore_id}
  */
  readonly datastoreId: string;
  /**
  * The primary key value that identifies the item to retrieve.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/data-sources/datastore_item#item_key DataDatadogDatastoreItem#item_key}
  */
  readonly itemKey: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/data-sources/datastore_item datadog_datastore_item}
*/
export class DataDatadogDatastoreItem extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataDatadogDatastoreItem that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/data-sources/datastore_item#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/data-sources/datastore_item datadog_datastore_item} Data Source
  *
  * @param scope The scope in which to define this construct
