...
// https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/governance_control
...
export interface GovernanceControlConfig extends cdktn.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/governance_control#detection_parameters GovernanceControl#detection_parameters}
  */
  readonly detectionParameters?: string;
  /**
  * The detection type that uniquely identifies the control, for example `unused_api_keys`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/governance_control#detection_type GovernanceControl#detection_type}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/governance_control#mitigation_parameters GovernanceControl#mitigation_parameters}
  */
  readonly mitigationParameters?: string;
  /**
  * The mitigation type configured for the control. Empty when not configured.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/governance_control#mitigation_type GovernanceControl#mitigation_type}
  */
  readonly mitigationType?: string;
  /**
  * The notification settings for the control, one entry per event type.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/governance_control#notification_settings GovernanceControl#notification_settings}
  */
...
export interface GovernanceControlNotificationSettingsTargets {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/governance_control#handle GovernanceControl#handle}
  */
  readonly handle: string;
  /**
  * The type of notification target: `email`, `slack`, `at_mention`, or `case`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/governance_control#type GovernanceControl#type}
  */
...
export interface GovernanceControlNotificationSettings {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/governance_control#enabled GovernanceControl#enabled}
  */
  readonly enabled: boolean | cdktn.IResolvable;
  /**
  * The event type the notification settings apply to, such as `new_detection`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/governance_control#event_type GovernanceControl#event_type}
  */
  readonly eventType: string;
  /**
  * The destinations that receive notifications for this event type.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/governance_control#targets GovernanceControl#targets}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/governance_control datadog_governance_control}
*/
export class GovernanceControl extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing GovernanceControl that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/governance_control#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/governance_control datadog_governance_control} Resource
  *
  * @param scope The scope in which to define this construct
