...
// https://registry.terraform.io/providers/datadog/datadog/4.11.0/docs/resources/org_group_policy
...
export class OrgGroupPolicy extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing OrgGroupPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/4.11.0/docs/resources/org_group_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/datadog/datadog/4.11.0/docs/resources/org_group_policy datadog_org_group_policy} Resource
  *
  * @param scope The scope in which to define this construct
