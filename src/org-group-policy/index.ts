...
// https://registry.terraform.io/providers/datadog/datadog/4.21.0/docs/resources/org_group_policy
...
export interface OrgGroupPolicyConfig extends cdktn.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.21.0/docs/resources/org_group_policy#content OrgGroupPolicy#content}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.21.0/docs/resources/org_group_policy#enforcement_tier OrgGroupPolicy#enforcement_tier}
  */
  readonly enforcementTier?: string;
  /**
  * The UUID of the org group this policy belongs to. Must be a valid UUID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.21.0/docs/resources/org_group_policy#org_group_id OrgGroupPolicy#org_group_id}
  */
  readonly orgGroupId: string;
  /**
  * The name of the policy. String length must be at least 1.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.21.0/docs/resources/org_group_policy#policy_name OrgGroupPolicy#policy_name}
  */
  readonly policyName: string;
  /**
  * The type of the policy. Valid values are `org_config`, `role`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.21.0/docs/resources/org_group_policy#policy_type OrgGroupPolicy#policy_type}
  */
  readonly policyType?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/datadog/datadog/4.21.0/docs/resources/org_group_policy datadog_org_group_policy}
*/
export class OrgGroupPolicy extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing OrgGroupPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/4.21.0/docs/resources/org_group_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/datadog/datadog/4.21.0/docs/resources/org_group_policy datadog_org_group_policy} Resource
  *
  * @param scope The scope in which to define this construct
