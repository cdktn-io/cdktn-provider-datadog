...
// https://registry.terraform.io/providers/datadog/datadog/4.12.1/docs/data-sources/team
...
export class DataDatadogTeam extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataDatadogTeam that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/4.12.1/docs/data-sources/team#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/datadog/datadog/4.12.1/docs/data-sources/team datadog_team} Data Source
  *
  * @param scope The scope in which to define this construct
