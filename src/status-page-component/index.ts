...
// https://registry.terraform.io/providers/datadog/datadog/4.21.0/docs/resources/status_page_component
...
export interface StatusPageComponentConfig extends cdktn.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.21.0/docs/resources/status_page_component#components StatusPageComponent#components}
  */
  readonly components?: StatusPageComponentComponents[] | cdktn.IResolvable;
  /**
  * The name of the component.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.21.0/docs/resources/status_page_component#name StatusPageComponent#name}
  */
  readonly name: string;
  /**
  * The ID of the status page this component belongs to.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.21.0/docs/resources/status_page_component#page_id StatusPageComponent#page_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.21.0/docs/resources/status_page_component#position StatusPageComponent#position}
  */
  readonly position: number;
  /**
  * The type of the component. Valid values are: component, group.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.21.0/docs/resources/status_page_component#type StatusPageComponent#type}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/datadog/datadog/4.21.0/docs/resources/status_page_component datadog_status_page_component}
*/
export class StatusPageComponent extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing StatusPageComponent that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/4.21.0/docs/resources/status_page_component#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/datadog/datadog/4.21.0/docs/resources/status_page_component datadog_status_page_component} Resource
  *
  * @param scope The scope in which to define this construct
