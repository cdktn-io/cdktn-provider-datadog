...
// https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/tag_indexing_rule_order
...
export interface TagIndexingRuleOrderConfig extends cdktn.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/tag_indexing_rule_order#name TagIndexingRuleOrder#name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/tag_indexing_rule_order#rule_ids TagIndexingRuleOrder#rule_ids}
  */
  readonly ruleIds: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/tag_indexing_rule_order datadog_tag_indexing_rule_order}
*/
export class TagIndexingRuleOrder extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing TagIndexingRuleOrder that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/tag_indexing_rule_order#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/tag_indexing_rule_order datadog_tag_indexing_rule_order} Resource
  *
  * @param scope The scope in which to define this construct
