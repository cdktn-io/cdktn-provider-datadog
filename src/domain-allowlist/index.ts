...
// https://registry.terraform.io/providers/datadog/datadog/4.12.1/docs/resources/domain_allowlist
...
export class DomainAllowlist extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing DomainAllowlist that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/4.12.1/docs/resources/domain_allowlist#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/datadog/datadog/4.12.1/docs/resources/domain_allowlist datadog_domain_allowlist} Resource
  *
  * @param scope The scope in which to define this construct
