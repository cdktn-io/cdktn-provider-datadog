...
// https://registry.terraform.io/providers/datadog/datadog/4.12.0/docs/resources/team_hierarchy_links
...
export class TeamHierarchyLinks extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing TeamHierarchyLinks that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/4.12.0/docs/resources/team_hierarchy_links#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/datadog/datadog/4.12.0/docs/resources/team_hierarchy_links datadog_team_hierarchy_links} Resource
  *
  * @param scope The scope in which to define this construct
