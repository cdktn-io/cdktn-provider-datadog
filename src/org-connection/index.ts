...
// https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/org_connection
...
export interface OrgConnectionConfig extends cdktn.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/org_connection#connection_types OrgConnection#connection_types}
  */
  readonly connectionTypes: string[];
  /**
  * UUID of the sink (destination) organization. Must be a valid UUID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/org_connection#sink_org_id OrgConnection#sink_org_id}
  */
  readonly sinkOrgId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/org_connection datadog_org_connection}
*/
export class OrgConnection extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing OrgConnection that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/org_connection#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/org_connection datadog_org_connection} Resource
  *
  * @param scope The scope in which to define this construct
