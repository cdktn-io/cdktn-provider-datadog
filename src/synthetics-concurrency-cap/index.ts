...
// https://registry.terraform.io/providers/datadog/datadog/4.8.0/docs/resources/synthetics_concurrency_cap
...
export class SyntheticsConcurrencyCap extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing SyntheticsConcurrencyCap that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/4.8.0/docs/resources/synthetics_concurrency_cap#import import section} in the documentation of this resource for the id to use
