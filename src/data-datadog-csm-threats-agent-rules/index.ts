...
// https://registry.terraform.io/providers/datadog/datadog/3.90.0/docs/data-sources/csm_threats_agent_rules
...
export class DataDatadogCsmThreatsAgentRules extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataDatadogCsmThreatsAgentRules that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/3.90.0/docs/data-sources/csm_threats_agent_rules#import import section} in the documentation of this resource for the id to use
