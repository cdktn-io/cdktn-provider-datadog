...
// https://registry.terraform.io/providers/datadog/datadog/4.11.0/docs/data-sources/csm_threats_agent_rules
...
export class DataDatadogCsmThreatsAgentRules extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataDatadogCsmThreatsAgentRules that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/4.11.0/docs/data-sources/csm_threats_agent_rules#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/datadog/datadog/4.11.0/docs/data-sources/csm_threats_agent_rules datadog_csm_threats_agent_rules} Data Source
  *
  * @param scope The scope in which to define this construct
