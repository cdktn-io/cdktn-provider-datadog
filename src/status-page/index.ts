...
// https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/status_page
...
export interface StatusPageConfig extends cdktn.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/status_page#company_logo StatusPage#company_logo}
  */
  readonly companyLogo?: string;
  /**
  * The subdomain prefix used to build the status page's URL.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/status_page#domain_prefix StatusPage#domain_prefix}
  */
  readonly domainPrefix: string;
  /**
  * The header image included in subscriber emails.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/status_page#email_header_image StatusPage#email_header_image}
  */
  readonly emailHeaderImage?: string;
  /**
  * The favicon displayed for the status page.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/status_page#favicon StatusPage#favicon}
  */
  readonly favicon?: string;
  /**
  * The name of the status page.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/status_page#name StatusPage#name}
  */
  readonly name: string;
  /**
  * The icon used for the status page's Slack app integration.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/status_page#slack_app_icon StatusPage#slack_app_icon}
  */
  readonly slackAppIcon?: string;
  /**
  * Whether Slack subscriber notifications are enabled for the status page.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/status_page#slack_subscriptions_enabled StatusPage#slack_subscriptions_enabled}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/status_page#subscriptions_enabled StatusPage#subscriptions_enabled}
  */
  readonly subscriptionsEnabled?: boolean | cdktn.IResolvable;
  /**
  * The type of the status page. Valid values are: public, internal.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/status_page#type StatusPage#type}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/status_page#visualization_type StatusPage#visualization_type}
  */
  readonly visualizationType: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/status_page datadog_status_page}
*/
export class StatusPage extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing StatusPage that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/status_page#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/datadog/datadog/4.22.0/docs/resources/status_page datadog_status_page} Resource
  *
  * @param scope The scope in which to define this construct
