...
# CDKTN prebuilt bindings for DataDog/datadog provider version 4.12.0

This repo builds and publishes the [Terraform datadog provider](https://registry.terraform.io/providers/DataDog/datadog/4.12.0/docs) bindings for [CDK Terrain](https://cdktn.io).
...
- [Terraform datadog provider](https://registry.terraform.io/providers/DataDog/datadog/4.12.0)
